...
(CFNC-3.99 "void gdk_content_serialize_async GOutputStream* stream char* mime_type const GValue* value int io_priority GCancellable* cancellable GAsyncReadyCallback callback gpointer user_data" 'const)
...
(CFNC-3.99 "gboolean gtk_selection_data_get_targets GtkSelectionData* selection_data GdkAtom** targets gint* n_atoms")
