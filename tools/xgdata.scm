...
(CFNC-3.98 "void g_menu_item_set_label GMenuItem* menu_item dd gchar* label")
...
(CFNC-3.98 "void g_menu_item_set_action_and_target_value GMenuItem* menu_item d gchar* action d GVariant* target_value")
...
(CFNC-3.98 "void gtk_accelerator_set_default_mod_mask GdkModifierType default_mod_mask")
...
(CFNC-3.98 "void gtk_shortcut_set_arguments GtkShortcut* self GVariant* args")
...
(CFNC-3.98 "gboolean gtk_shortcut_action_activate GtkShortcutAction* self GtkShortcutActionFlags flags GtkWidget* widget GVariant* args")
(CFNC-3.98 "GtkShortcutAction* gtk_nothing_action_get void")
(CFNC-3.98 "GtkShortcutAction* gtk_callback_action_new GtkShortcutFunc callback gpointer data GDestroyNotify destroy")
