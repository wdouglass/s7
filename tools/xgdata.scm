...
;; GdkWindow -> GdkDrawable in gtk 2.2 -> GdkSurface in 3.99
...
;;; 3.92.1 (CFNC "GdkWindow* gdk_get_default_root_window void")
...
;;; 3.94.0 (CFNC-3.0 "GdkWindow* gdk_device_get_window_at_position GdkDevice* device gint* [win_x] gint* [win_y]")
...
;;; 3.9.8:
;;; 3.94.0 (CFNC-3.10 "cairo_surface_t* gdk_cairo_surface_create_from_pixbuf GdkPixbuf* pixbuf int scale GdkWindow* for_window")
...
;;; 3.11.9
;;; 3.94.0 (CFNC-3.12 "GdkWindow* gdk_device_get_last_event_window GdkDevice* device")
...
;;; 3.94.0 (CFNC-3.16 "void gdk_cairo_draw_from_gl cairo_t* cr GdkWindow* window int source int source_type int buffer_scale int x int y int width int height")
...
;;; 3.94.0 (CFNC-3.22 "GdkWindow* gdk_drawing_context_get_window GdkDrawingContext* context")
...
(CINT-3.99 "GDK_WINDOW_STATE_TOP_TILED" "GdkWindowState")
(CINT-3.99 "GDK_WINDOW_STATE_TOP_RESIZABLE" "GdkWindowState")
(CINT-3.99 "GDK_WINDOW_STATE_RIGHT_TILED" "GdkWindowState")
(CINT-3.99 "GDK_WINDOW_STATE_RIGHT_RESIZABLE" "GdkWindowState")
(CINT-3.99 "GDK_WINDOW_STATE_BOTTOM_TILED" "GdkWindowState")
(CINT-3.99 "GDK_WINDOW_STATE_BOTTOM_RESIZABLE" "GdkWindowState")
(CINT-3.99 "GDK_WINDOW_STATE_LEFT_TILED" "GdkWindowState")
(CINT-3.99 "GDK_WINDOW_STATE_LEFT_RESIZABLE" "GdkWindowState")
...
;;; 3.94.0 GdkWindow->GdkSurface and presumably gdk_window
;;;        gdkcairocontext.h gdkdrop.h gdkgltexture.h gdkmemorytexture.h gdkpaintable.h gdksnapshot.h gdksurface.h gtkeventcontrollerkey.h  gtkgesturestylus.h
;;;        gtkmediacontrols.h gtkmediafile.h gtkmediastream.h gtkpicture.h gtkvideo.h  gtkwidgetpaintable.h
#|
(CFNC-3.99 "void gdk_cairo_draw_from_gl cairo_t* cr GdkSurface* window int source int source_type int buffer_scale int x int y int width int height")
(CFNC-3.99 "void gdk_device_get_state GdkDevice* device GdkSurface* window gdouble* axes GdkModifierType* [mask]")
(CFNC-3.99 "GdkSurface* gdk_device_get_surface_at_position GdkDevice* device gint* [win_x] gint* [win_y]")
(CFNC-3.99 "gboolean gdk_device_get_history GdkDevice* device GdkSurface* window guint32 start guint32 stop GdkTimeCoord*** [events]")
(CFNC-3.99 "GdkSurface* gdk_device_get_last_event_window GdkDevice* device")

(CINT-3.99 "GDK_MODE_DISABLED" "GdkInputMode")
(CINT-3.99 "GDK_MODE_SCREEN" "GdkInputMode")
(CINT-3.99 "GDK_MODE_SURFACE" "GdkInputMode")
|#
;;; perhaps find/replace all window->surface, and wait for compiler to catch the rest -- there are
;;;   too many silly header changes to dig through!  
