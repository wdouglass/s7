...
(CFNC-3.92 "void gtk_style_context_set_frame_clock GtkStyleContext* context GdkFrameClock* frame_clock")
(CFNC-3.92 "GdkFrameClock* gtk_style_context_get_frame_clock GtkStyleContext* context")
...
(CFNC-3.99 "void gdk_event_set_keyval GdkEvent* event guint keyval")
(CFNC-3.99 "gboolean gdk_event_get_key_is_modifier GdkEvent* event gboolean* [is_modifier]")
(CFNC-3.99 "gboolean gdk_event_get_key_group GdkEvent* event guint* [group]")
;;; 3.96.0 (CFNC-3.99 "gboolean gdk_event_get_string GdkEvent* event char** [string]" 'const)
(CFNC-3.99 "gboolean gdk_event_get_setting GdkEvent* event char** [setting]" 'const)
(CFNC-3.99 "gboolean gdk_event_is_sent GdkEvent* event")
(CFNC-3.99 "gboolean gdk_event_get_drag_context GdkEvent* event GdkDrag** [context]")
(CFNC-3.99 "gboolean gdk_event_get_crossing_mode GdkEvent* event GdkCrossingMode* [mode]")
(CFNC-3.99 "gboolean gdk_event_get_crossing_detail GdkEvent* event GdkNotifyType* [detail]")
(CFNC-3.99 "gboolean gdk_event_get_touchpad_gesture_phase GdkEvent* event GdkTouchpadGesturePhase* [phase]")
(CFNC-3.99 "gboolean gdk_event_get_touchpad_gesture_n_fingers GdkEvent* event guint* [n_fingers]")
(CFNC-3.99 "gboolean gdk_event_get_touchpad_deltas GdkEvent* event double* [dx] double* [dy]")
(CFNC-3.99 "gboolean gdk_event_get_touchpad_angle_delta GdkEvent* event double* [delta]")
...
;;; 3.96.0 (CFNC-3.99 "void gtk_snapshot_push_blur GtkSnapshot* snapshot double radius char* name" 'const)
(CFNC-3.99 "GtkWidget* gtk_emoji_chooser_new void")
(CFNC-3.99 "GtkEventController* gtk_event_controller_scroll_new GtkWidget* widget GtkEventControllerScrollFlags flags")
...
;;; 3.96.0 (CFNC-3.99 "GdkDisplay* gdk_drag_context_get_display GdkDrag* context")
;;; 3.96.0 (CFNC-3.99 "GdkContentFormats* gdk_drag_context_get_formats GdkDrag* context")
...
;;; 3.96.0 (CFNC-3.99 "GdkDrag* gtk_drag_begin_with_coordinates GtkWidget* widget GdkDevice* device GdkContentFormats* targets GdkDragAction actions gint x gint y")
...
;;; 3.96.0 (CFNC-3.99 "GtkWidget* gtk_invisible_new_for_display GdkDisplay* display")
;;; 3.96.0 (CFNC-3.99 "void gtk_invisible_set_display GtkInvisible* invisible GdkDisplay* display")
;;; 3.96.0 (CFNC-3.99 "GdkDisplay*gtk_invisible_get_display GtkInvisible* invisible")
;;; 3.96.0 (CFNC-3.99 "void gtk_menu_set_display GtkMenu* menu GdkDisplay* display")
...
;;; 3.96.0 (CFNC-3.99 "GtkWidget* gtk_widget_pick GtkWidget* widget gdouble x gdouble y")
...
;;; 3.96.0 (CFNC-3.99 "void gtk_window_set_icon GtkWindow* window GdkTexture* icon")
;;; 3.96.0 (CFNC-3.99 "GdkTexture* gtk_window_get_icon GtkWindow* window")
...
(CINT-3.99 "GDK_MODE_DISABLED" "GdkInputMode")
(CINT-3.99 "GDK_MODE_SCREEN" "GdkInputMode")
(CINT-3.99 "GDK_MODE_SURFACE" "GdkInputMode")
...
;;;; (CFNC-3.99 "void gdk_device_get_state GdkDevice* device GdkSurface* window gdouble* axes GdkModifierType* [mask]")
;;;; (CFNC-3.99 "gboolean gdk_device_get_history GdkDevice* device GdkSurface* window guint32 start guint32 stop GdkTimeCoord*** [events] gint* [n_events]")
;;;; (CFNC-3.99 "void gdk_input_set_extension_events GdkSurface* window gint mask GdkExtensionMode mode")
;; GdkSurface -> GdkDrawable in gtk 2.2 -> GdkSurface in 3.99
;;; 3.93.0 (CFNC-3.99 "gboolean gdk_property_get GdkSurface* window GdkAtom property GdkAtom type gulong offset gulong length gint pdelete GdkAtom* [actual_property_type] gint* [actual_format] gint* [actual_length] guchar** [data]") 
;;; 3.93.0 (CFNC-3.99 "void gdk_property_change GdkSurface* window GdkAtom property GdkAtom type gint format GdkPropMode mode guchar* data gint nelements")
...
;;; 3.93.0 (CFNC-3.99 "gboolean gdk_selection_property_get GdkSurface* requestor guchar** [data] GdkAtom* [prop_type] gint* [prop_format]")
;;; 3.92.1 (CINT-3.99 "GDK_INPUT_OUTPUT" "GdkSurfaceClass") ; GdkSurfaceWindowClass in gtk 3
;;; 3.92.1 (CINT-3.99 "GDK_INPUT_ONLY" "GdkSurfaceClass")
;;; 2.90.7 (CINT-3.99 "GDK_SURFACE_DIALOG" "GdkSurfaceType")
;;; 3.92.1 (CINT-3.99 "GDK_WA_TITLE" "GdkSurfaceAttributesType")
;;; 3.92.1 (CINT-3.99 "GDK_WA_X" "GdkSurfaceAttributesType")
;;; 3.92.1 (CINT-3.99 "GDK_WA_Y" "GdkSurfaceAttributesType")
;;; 3.92.1 (CINT-3.99 "GDK_WA_CURSOR" "GdkSurfaceAttributesType")
;;; 2.91.0 (CINT-3.99 "GDK_WA_COLORMAP" "GdkSurfaceAttributesType")
;;; 3.92.1 (CINT-3.99 "GDK_WA_VISUAL" "GdkSurfaceAttributesType")
;;; 3.92.1 (CINT-3.99 "GDK_WA_WMCLASS" "GdkSurfaceAttributesType")
;;; 3.92.1 (CINT-3.99 "GDK_WA_NOREDIR" "GdkSurfaceAttributesType")
;;; 3.92.1 (CFNC-3.99 "GdkSurface* gdk_get_default_root_window void")
...
;;;; 2.90.6 (CFNC-3.99 "void gtk_paint_polygon GtkStyle* style GdkSurface* window GtkStateType state_type GtkShadowType shadow_type GdkRectangle* area GtkWidget* widget gchar* detail GdkPoint* points gint npoints gboolean fill")
...
(CINT-3.99 "GDK_SURFACE_TOPLEVEL" "GdkSurfaceType")
(CINT-3.99 "GDK_SURFACE_CHILD" "GdkSurfaceType")
(CINT-3.99 "GDK_SURFACE_TEMP" "GdkSurfaceType")
;;; 3.96 (CINT-3.99 "GDK_SURFACE_SUBSURFACE" "GdkSurfaceType")

(CINT-3.99 "GDK_HINT_POS" "GdkSurfaceHints")
(CINT-3.99 "GDK_HINT_MIN_SIZE" "GdkSurfaceHints")
(CINT-3.99 "GDK_HINT_MAX_SIZE" "GdkSurfaceHints")
(CINT-3.99 "GDK_HINT_BASE_SIZE" "GdkSurfaceHints")
(CINT-3.99 "GDK_HINT_ASPECT" "GdkSurfaceHints")
(CINT-3.99 "GDK_HINT_RESIZE_INC" "GdkSurfaceHints")
(CINT-3.99 "GDK_HINT_WIN_GRAVITY" "GdkSurfaceHints")
(CINT-3.99 "GDK_HINT_USER_POS" "GdkSurfaceHints")
(CINT-3.99 "GDK_HINT_USER_SIZE" "GdkSurfaceHints")
...
(CINT-3.99 "GDK_SURFACE_TYPE_HINT_TOOLBAR" "GdkSurfaceTypeHint")
...
(CFNC-3.99 "GList* gdk_surface_get_children GdkSurface* surface")
;;; 3.96.0 (CFNC-3.99 "GList* gdk_surface_get_children_with_user_data GdkSurface* surface gpointer user_data")
(CFNC-3.99 "GList* gdk_surface_peek_children GdkSurface* surface")
...
;;; 3.96.0 (CFNC-3.99 "GdkDrag* gdk_drag_begin GdkSurface* window GdkDevice* device GdkContentProvider* content GdkDragAction actions gint dx gint dy")
(CFNC-3.99 "GdkDrawingContext* gdk_surface_begin_draw_frame GdkSurface* window GdkDrawContext* context cairo_region_t* region")
(CFNC-3.99 "GdkEventMask gdk_surface_get_device_events GdkSurface* window GdkDevice* device")
(CFNC-3.99 "GdkEventMask gdk_surface_get_events GdkSurface* window")
(CFNC-3.99 "GdkFrameClock* gdk_surface_get_frame_clock GdkSurface* surface")
(CFNC-3.99 "GdkFullscreenMode gdk_surface_get_fullscreen_mode GdkSurface* surface")
(CFNC-3.99 "GdkGLContext* gdk_surface_create_gl_context GdkSurface* surface GError** error")
(CFNC-3.99 "GdkGrabStatus gdk_seat_grab GdkSeat* seat GdkSurface* window GdkSeatCapabilities capabilities gboolean owner_events GdkCursor* cursor GdkEvent* event GdkSeatGrabPrepareFunc prepare_func lambda_data @func_info") ; the name func_info is built-in
(CFNC-3.99 "GdkMonitor* gdk_display_get_monitor_at_window GdkDisplay* display GdkSurface* window")
(CFNC-3.99 "GdkPaintable* gdk_paintable_new_empty int intrinsic_width int intrinsic_height")
(CFNC-3.99 "GdkSurface* gdk_device_get_window_at_position_double GdkDevice* device gdouble* [win_x] gdouble* [win_y]")
(CFNC-3.99 "GdkSurface* gdk_display_get_default_group GdkDisplay* display") 
;;; 3.96.0 (CFNC-3.99 "GdkSurface* gdk_drag_context_get_drag_window GdkDrag* context")
;;; 3.96.0 (CFNC-3.99 "GdkSurface* gdk_drag_context_get_source_window GdkDrag* context")
(CFNC-3.99 "GdkSurface* gdk_event_get_window GdkEvent* event" 'const)
(CFNC-3.99 "GdkSurface* gdk_gl_context_get_window GdkGLContext* context")
;;; 3.96.0 (CFNC-3.99 "GdkSurface* gdk_surface_get_device_position GdkSurface* surface GdkDevice* device gint* x gint* y GdkModifierType* mask")
(CFNC-3.99 "GdkSurface* gdk_surface_get_device_position GdkSurface* surface GdkDevice* device gdouble* x gdouble* y GdkModifierType* mask")
;;; 3.96.0 (CFNC-3.99 "GdkSurface* gdk_surface_get_group GdkSurface* window")
(CFNC-3.99 "GdkSurface* gdk_surface_get_parent GdkSurface* surface")
(CFNC-3.99 "GdkSurface* gdk_surface_get_toplevel GdkSurface* surface")
(CFNC-3.99 "GdkSurface* gdk_surface_new_child GdkSurface* parent const GdkRectangle* position")
(CFNC-3.99 "GdkSurface* gdk_surface_new_popup GdkDisplay* display const GdkRectangle* position")
(CFNC-3.99 "GdkSurface* gdk_surface_new_temp GdkDisplay* display")
(CFNC-3.99 "GdkSurface* gdk_surface_new_toplevel GdkDisplay* display gint event_mask int width int height")
(CFNC-3.99 "GdkSurface* gtk_widget_get_parent_window GtkWidget* widget")
(CFNC-3.99 "GdkSurface* gtk_widget_get_window GtkWidget* widget")
(CFNC-3.99 "GdkSurface*gdk_surface_get_group GdkSurface* surface")
(CFNC-3.99 "GdkSurfaceState gdk_surface_get_state GdkSurface* surface")
(CFNC-3.99 "GdkSurfaceType gdk_surface_get_surface_type GdkSurface* surface")
(CFNC-3.99 "GdkSurfaceType gdk_surface_get_window_type GdkSurface* window")
(CFNC-3.99 "GdkSurfaceTypeHint gdk_surface_get_type_hint GdkSurface* window")
(CFNC-3.99 "GdkSurfaceTypeHint gtk_window_get_type_hint GtkWindow* window")
(CFNC-3.99 "GdkVulkanContext* gdk_surface_create_vulkan_context GdkSurface* surface GError** error")
(CFNC-3.99 "cairo_region_t* gdk_surface_get_clip_region GdkSurface* window")
(CFNC-3.99 "cairo_region_t* gdk_surface_get_update_area GdkSurface* window")
(CFNC-3.99 "cairo_region_t* gdk_surface_get_visible_region GdkSurface* window")
(CFNC-3.99 "cairo_surface_t* gdk_surface_create_similar_image_surface GdkSurface* window cairo_format_t format int width int height int scale")
...
(CFNC-3.99 "cairo_surface_t* gtk_icon_info_load_surface GtkIconInfo* icon_info GdkSurface* for_window GError** [error]")
(CFNC-3.99 "cairo_surface_t* gtk_icon_theme_load_surface GtkIconTheme* icon_theme gchar* icon_name gint size gint scale GdkSurface* for_window GtkIconLookupFlags flags GError** [error]" 'const)
(CFNC-3.99 "gboolean gdk_event_get_grab_window GdkEvent* event GdkSurface** [window]")
(CFNC-3.99 "gboolean gdk_surface_get_accept_focus GdkSurface* surface")
(CFNC-3.99 "gboolean gdk_surface_get_decorations GdkSurface* surface GdkWMDecoration* decorations")
(CFNC-3.99 "gboolean gdk_surface_get_focus_on_map GdkSurface* surface")
(CFNC-3.99 "gboolean gdk_surface_get_modal_hint GdkSurface* surface")
(CFNC-3.99 "gboolean gdk_surface_get_pass_through GdkSurface* surface")
(CFNC-3.99 "gboolean gdk_surface_get_support_multidevice GdkSurface* surface")
(CFNC-3.99 "gboolean gdk_surface_has_native GdkSurface* surface")
(CFNC-3.99 "gboolean gdk_surface_is_destroyed GdkSurface* surface")
(CFNC-3.99 "gboolean gdk_surface_is_input_only GdkSurface* surface")
(CFNC-3.99 "gboolean gdk_surface_is_shaped GdkSurface* window")
(CFNC-3.99 "gboolean gdk_surface_is_viewable GdkSurface* surface")
(CFNC-3.99 "gboolean gdk_surface_is_visible GdkSurface* surface")
(CFNC-3.99 "gboolean gdk_surface_show_window_menu GdkSurface* surface GdkEvent* event")
(CFNC-3.99 "gint gdk_surface_get_origin GdkSurface* surface gint* x gint* y")
(CFNC-3.99 "gint gdk_surface_get_scale_factor GdkSurface* surface")
(CFNC-3.99 "int gdk_surface_get_height GdkSurface* surface")
(CFNC-3.99 "int gdk_surface_get_width GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_add_filter GdkSurface* window GdkFilterFunc func lambda_data @func_info")
(CFNC-3.99 "void gdk_surface_beep GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_begin_move_drag GdkSurface* surface gint button gint x gint y guint32 timestamp")
(CFNC-3.99 "void gdk_surface_begin_move_drag_for_device GdkSurface* surface GdkDevice* device gint button gint x gint y guint32 timestamp")
(CFNC-3.99 "void gdk_surface_begin_resize_drag GdkSurface* surface GdkSurfaceEdge edge gint button gint root_x gint root_y guint32 timestamp")
(CFNC-3.99 "void gdk_surface_begin_resize_drag_for_device GdkSurface* surface GdkSurfaceEdge edge GdkDevice* device gint button gint x gint y guint32 timestamp")
(CFNC-3.99 "void gdk_surface_constrain_size GdkGeometry* geometry GdkSurfaceHints flags gint width gint height gint* [new_width] gint* [new_height]")
(CFNC-3.99 "void gdk_surface_coords_from_parent GdkSurface* surface gdouble parent_x gdouble parent_y gdouble* x gdouble* y")
(CFNC-3.99 "void gdk_surface_coords_to_parent GdkSurface* surface gdouble x gdouble y gdouble* parent_x gdouble* parent_y")
(CFNC-3.99 "void gdk_surface_deiconify GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_destroy GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_end_draw_frame GdkSurface* window GdkDrawingContext* context")
(CFNC-3.99 "void gdk_surface_focus GdkSurface* surface guint32 timestamp")
(CFNC-3.99 "void gdk_surface_freeze_updates GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_fullscreen GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_fullscreen_on_monitor GdkSurface* surface GdkMonitor* monitor")
(CFNC-3.99 "void gdk_surface_get_frame_extents GdkSurface* surface GdkRectangle* rect")
(CFNC-3.99 "void gdk_surface_get_geometry GdkSurface* surface gint* x gint* y gint* width gint* height")
(CFNC-3.99 "void gdk_surface_get_position GdkSurface* surface gint* x gint* y")
(CFNC-3.99 "void gdk_surface_get_root_coords GdkSurface* surface gint x gint y gint* root_x gint* root_y")
(CFNC-3.99 "void gdk_surface_get_root_origin GdkSurface* surface gint* x gint* y")
(CFNC-3.99 "void gdk_surface_get_user_data GdkSurface* surface gpointer* data")
(CFNC-3.99 "void gdk_surface_hide GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_iconify GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_input_shape_combine_region GdkSurface* surface const cairo_region_t* shape_region gint offset_x gint offset_y")
;;; 3.96.0 (CFNC-3.99 "void gdk_surface_invalidate_rect GdkSurface* surface const GdkRectangle* rect")
;;; 3.96.0 (CFNC-3.99 "void gdk_surface_invalidate_region GdkSurface* surface const cairo_region_t* region")
(CFNC-3.99 "void gdk_surface_lower GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_maximize GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_merge_child_input_shapes GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_merge_child_shapes GdkSurface* window")
(CFNC-3.99 "void gdk_surface_move GdkSurface* surface gint x gint y")
(CFNC-3.99 "void gdk_surface_move_region GdkSurface* window cairo_region_t* region gint dx gint dy")
(CFNC-3.99 "void gdk_surface_move_resize GdkSurface* window gint x gint y gint width gint height")
(CFNC-3.99 "void gdk_surface_move_to_rect GdkSurface* surface const GdkRectangle* rect GdkGravity rect_anchor GdkGravity surface_anchor GdkAnchorHints anchor_hints gint rect_anchor_dx gint rect_anchor_dy")
(CFNC-3.99 "void gdk_surface_queue_expose GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_raise GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_register_dnd GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_remove_filter GdkSurface* window GdkFilterFunc func lambda_data @func_info")
(CFNC-3.99 "void gdk_surface_resize GdkSurface* surface gint width gint height")
(CFNC-3.99 "void gdk_surface_restack GdkSurface* surface GdkSurface* sibling gboolean above")
(CFNC-3.99 "void gdk_surface_scroll GdkSurface* window gint dx gint dy")
(CFNC-3.99 "void gdk_surface_set_accept_focus GdkSurface* surface gboolean accept_focus")
(CFNC-3.99 "void gdk_surface_set_child_input_shapes GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_set_child_shapes GdkSurface* window")
(CFNC-3.99 "void gdk_surface_set_cursor GdkSurface* surface GdkCursor* cursor")
(CFNC-3.99 "void gdk_surface_set_decorations GdkSurface* surface GdkWMDecoration decorations")
(CFNC-3.99 "void gdk_surface_set_device_cursor GdkSurface* surface GdkDevice* device GdkCursor* cursor")
(CFNC-3.99 "void gdk_surface_set_device_events GdkSurface* window GdkDevice* device GdkEventMask event_mask")
(CFNC-3.99 "void gdk_surface_set_events GdkSurface* window GdkEventMask event_mask")
(CFNC-3.99 "void gdk_surface_set_focus_on_map GdkSurface* surface gboolean focus_on_map")
(CFNC-3.99 "void gdk_surface_set_fullscreen_mode GdkSurface* surface GdkFullscreenMode mode")
(CFNC-3.99 "void gdk_surface_set_functions GdkSurface* surface GdkWMFunction functions")
(CFNC-3.99 "void gdk_surface_set_geometry_hints GdkSurface* surface const GdkGeometry* geometry GdkSurfaceHints geom_mask")
;;; 3.96.0 (CFNC-3.99 "void gdk_surface_set_group GdkSurface* surface GdkSurface* leader")
(CFNC-3.99 "void gdk_surface_set_icon_list GdkSurface* surface GList* surfaces")
(CFNC-3.99 "void gdk_surface_set_icon_name GdkSurface* surface const gchar* name")
(CFNC-3.99 "void gdk_surface_set_keep_above GdkSurface* surface gboolean setting")
(CFNC-3.99 "void gdk_surface_set_keep_below GdkSurface* surface gboolean setting")
(CFNC-3.99 "void gdk_surface_set_modal_hint GdkSurface* surface gboolean modal")
(CFNC-3.99 "void gdk_surface_set_opacity GdkSurface* surface gdouble opacity")
(CFNC-3.99 "void gdk_surface_set_opaque_region GdkSurface* surface cairo_region_t* region")
(CFNC-3.99 "void gdk_surface_set_pass_through GdkSurface* surface gboolean pass_through")
;;; 3.96.0 (CFNC-3.99 "void gdk_surface_set_role GdkSurface* surface const gchar* role")
(CFNC-3.99 "void gdk_surface_set_shadow_width GdkSurface* surface gint left gint right gint top gint bottom")
(CFNC-3.99 "void gdk_surface_set_skip_pager_hint GdkSurface* surface gboolean skips_pager")
(CFNC-3.99 "void gdk_surface_set_skip_taskbar_hint GdkSurface* surface gboolean skips_taskbar")
(CFNC-3.99 "void gdk_surface_set_startup_id GdkSurface* surface const gchar* startup_id")
(CFNC-3.99 "void gdk_surface_set_support_multidevice GdkSurface* surface gboolean support_multidevice")
(CFNC-3.99 "void gdk_surface_set_title GdkSurface* surface const gchar* title")
(CFNC-3.99 "void gdk_surface_set_transient_for GdkSurface* surface GdkSurface* parent")
(CFNC-3.99 "void gdk_surface_set_type_hint GdkSurface* surface GdkSurfaceTypeHint hint")
;;; 3.96.0 (CFNC-3.99 "void gdk_surface_set_urgency_hint GdkSurface* surface gboolean urgent")
(CFNC-3.99 "void gdk_surface_set_user_data GdkSurface* @window gpointer user_data")
(CFNC-3.99 "void gdk_surface_shape_combine_region GdkSurface* window cairo_region_t* shape_region gint offset_x gint offset_y")
(CFNC-3.99 "void gdk_surface_show GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_show_unraised GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_stick GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_thaw_updates GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_unfullscreen GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_unmaximize GdkSurface* surface")
(CFNC-3.99 "void gdk_surface_unstick GdkSurface* surface")
;;; 3.96.0 (CFNC-3.99 "void gdk_surface_withdraw GdkSurface* surface")
(CFNC-3.99 "void gtk_menu_popup_at_rect GtkMenu* menu GdkSurface* rect_window GdkRectangle* rect GdkGravity rect_anchor GdkGravity menu_anchor GdkEvent* trigger_event")
(CFNC-3.99 "void gtk_widget_register_window GtkWidget* widget GdkSurface* window")
(CFNC-3.99 "void gtk_widget_set_parent_window GtkWidget* widget GdkSurface* parent_window")
(CFNC-3.99 "void gtk_widget_set_window GtkWidget* widget GdkSurface* window")
(CFNC-3.99 "void gtk_widget_unregister_window GtkWidget* widget GdkSurface* window")
(CFNC-3.99 "void gtk_window_begin_resize_drag GtkWindow* window GdkSurfaceEdge edge gint button gint x gint y guint32 timestamp")
(CFNC-3.99 "void gtk_window_set_type_hint GtkWindow* window GdkSurfaceTypeHint hint")
...
(CCAST-3.99 "GDK_MEMORY_TEXTURE(obj)" "GdkMemoryTexture*")
...
(CCHK-3.99 "GDK_IS_MEMORY_TEXTURE(obj)" "GdkMemoryTexture*")
...
(CINT-3.99 "GDK_SURFACE_STATE_ICONIFIED" "GdkSurfaceState")
...
(CFNC-3.99 "void gdk_drop_status GdkDrop* self GdkDragAction actions")
(CFNC-3.99 "void gdk_drop_finish GdkDrop* self GdkDragAction action")
(CFNC-3.99 "void gdk_drop_read_async GdkDrop* self const char** mime_types int io_priority GCancellable* cancellable GAsyncReadyCallback callback gpointer user_data")
(CFNC-3.99 "GInputStream* gdk_drop_read_finish GdkDrop* self GAsyncResult* result const char** out_mime_type GError** error")
...
(CFNC-3.99 "const GValue* gdk_drop_read_value_finish GdkDrop* self GAsyncResult* result GError** error")
(CFNC-3.99 "void gdk_drop_read_text_async GdkDrop* drop GCancellable* cancellable GAsyncReadyCallback callback gpointer user_data")
(CFNC-3.99 "char* gdk_drop_read_text_finish GdkDrop* drop GAsyncResult* result GError** error")
(CFNC-3.99 "GdkTexture* gdk_gl_texture_new GdkGLContext* context guint id int width int height GDestroyNotify destroy gpointer data")
(CFNC-3.99 "void gdk_gl_texture_release GdkGLTexture* self")
;;; 3.96.0 (CFNC-3.99 "void gdk_paintable_snapshot GdkPaintable* paintable GdkSnapshot* snapshot double width double height")
...
(CFNC-3.99 "GtkWidget* gtk_event_controller_get_widget GtkEventController* controller")
(CFNC-3.99 "gboolean gtk_event_controller_handle_event GtkEventController* controller const GdkEvent* event")
(CFNC-3.99 "void gtk_event_controller_reset GtkEventController* controller")
(CFNC-3.99 "GtkPropagationPhase gtk_event_controller_get_propagation_phase GtkEventController* controller")
(CFNC-3.99 "void gtk_event_controller_set_propagation_phase GtkEventController* controller GtkPropagationPhase phase")
(CFNC-3.99 "GtkGesture* gtk_gesture_stylus_new void")
(CFNC-3.99 "gboolean gtk_gesture_stylus_get_axis GtkGestureStylus* gesture GdkAxisUse axis gdouble* value")
(CFNC-3.99 "gboolean gtk_gesture_stylus_get_axes GtkGestureStylus* gesture GdkAxisUse axes[] gdouble** values")
...
(CFNC-3.99 "GtkMediaStream* gtk_media_file_new_for_filename const char* filename")
(CFNC-3.99 "GtkMediaStream* gtk_media_file_new_for_resource const char* resource_path")
...
(CFNC-3.99 "void gtk_media_file_set_filename GtkMediaFile* self const char* filename")
(CFNC-3.99 "void gtk_media_file_set_resource GtkMediaFile* self const char* resource_path")
...
(CFNC-3.99 "const GError* gtk_media_stream_get_error GtkMediaStream* self")
...
(CFNC-3.99 "GtkWidget* gtk_picture_new_for_filename const gchar* filename")
(CFNC-3.99 "GtkWidget* gtk_picture_new_for_resource const gchar* resource_path")
...
(CFNC-3.99 "void gtk_picture_set_filename GtkPicture* self const gchar* filename")
(CFNC-3.99 "void gtk_picture_set_resource GtkPicture* self const gchar* resource_path")
...
(CFNC-3.99 "void gtk_picture_set_alternative_text GtkPicture* self const char* alternative_text")
(CFNC-3.99 "const char* gtk_picture_get_alternative_text GtkPicture* self")
...
(CFNC-3.99 "GtkWidget* gtk_video_new_for_filename const char* filename")
(CFNC-3.99 "GtkWidget* gtk_video_new_for_resource const char* resource_path")
...
(CFNC-3.99 "void gtk_video_set_filename GtkVideo* self const char* filename")
(CFNC-3.99 "void gtk_video_set_resource GtkVideo* self const char* resource_path")
...
;;; 3.96.0
(CFNC-3.99 "void gtk_box_reorder_child GtkBox* box GtkWidget* child GtkWidget* sibling")
(CFNC-3.99 "GtkWidget* gtk_drag_get_source_widget GdkDrag* context")
...
(CFNC-3.99 "GtkWidget* gtk_menu_bar_new_from_model GMenuModel* model")
(CFNC-3.99 "gboolean gdk_surface_handle_event GdkEvent* event")
(CFNC-3.99 "GdkGrabStatus gdk_device_grab GdkDevice* device GdkSurface* surface GdkGrabOwnership grab_ownership gboolean owner_events GdkEventMask event_mask GdkCursor* cursor guint32 time_")
(CFNC-3.99 "void gdk_device_ungrab GdkDevice* device guint32 time_")
(CFNC-3.99 "void gtk_application_set_screensaver_active GtkApplication* application gboolean active")
...
(CFNC-3.99 "float gtk_editable_get_alignment GtkEditable* editable")
...
(CFNC-3.99 "GtkWidget* gtk_event_controller_key_get_focus_origin GtkEventControllerKey* controller")
(CFNC-3.99 "GtkWidget* gtk_event_controller_key_get_focus_target GtkEventControllerKey* controller")
(CFNC-3.99 "GtkWidget* gtk_event_controller_motion_get_pointer_origin GtkEventControllerMotion* controller")
(CFNC-3.99 "GtkWidget* gtk_event_controller_motion_get_pointer_target GtkEventControllerMotion* controller")
(CFNC-3.99 "void gtk_fixed_get_child_position GtkFixed* fixed GtkWidget* widget gint* x gint* y")
...
(CFNC-3.99 "void gtk_grid_query_child GtkGrid* grid GtkWidget* child gint* left gint* top gint* width gint* height")
...
(CFNC-3.99 "void gtk_popover_menu_add_submenu GtkPopoverMenu* popover GtkWidget* submenu char* name")
...
(CFNC-3.99 "GtkWidget* gtk_widget_pick GtkWidget* widget gdouble x gdouble y GtkPickFlags flags")
(CFNC-3.99 "void gtk_widget_activate_action GtkWidget* widget char* name GVariant* parameter")
...
(CFNC-3.99 "GdkDrag* gdk_drag_begin GdkSurface* surface GdkDevice* device GdkContentProvider* content GdkDragAction actions gint dx gint dy")
...
(CFNC-3.99 "void gdk_drag_set_hotspot GdkDrag* drag gint hot_x gint hot_y")
...
(CFNC-3.99 "gboolean gtk_filter_list_model_has_filter GtkFilterListModel* self")
(CFNC-3.99 "void gtk_filter_list_model_refilter GtkFilterListModel* self")
(CFNC-3.99 "GtkLayoutManager* gtk_fixed_layout_new void")
(CFNC-3.99 "void gtk_fixed_layout_child_set_position GtkFixedLayoutChild* child GskTransform* gtk_fixed_layout_child_get_position GtkFixedLayoutChild* child")
(CFNC-3.99 "GtkFlattenListModel* gtk_flatten_list_model_new GType item_type GListModel* model")
...
(CFNC-3.99 "GtkWidget* gtk_root_get_for_surface GdkSurface* surface")
...
(CFNC-3.99 "void gtk_selection_model_query_range GtkSelectionModel* model guint position guint* start_range guint* n_items gboolean* selected")
...
(CFNC-3.99 "void gtk_sort_list_model_resort GtkSortListModel* self")
...
(CFNC-3.99 "gint gtk_text_get_max_length GtkText* self")
...
(CFNC-3.99 "void gtk_text_grab_focus_without_selecting GtkText* self")
...
(CFNC-3.99 "void gtk_drag_get_data GtkWidget* widget GdkDrag* context GdkAtom target guint32 time")
(CFNC-3.99 "void gtk_drag_set_icon_widget GdkDrag* context GtkWidget* widget gint hot_x gint hot_y")
(CFNC-3.99 "void gtk_drag_set_icon_default GdkDrag* context")
(CFNC-3.99 "void gtk_drag_set_icon_name GdkDrag* context gchar* icon_name gint hot_x gint hot_y" 'const)
(CFNC-3.99 "void gtk_drag_set_icon_surface GdkDrag* context cairo_surface_t* surface")
(CFNC-3.99 "void gtk_drag_set_icon_gicon GdkDrag* context GIcon* icon gint hot_x gint hot_y")
(CFNC-3.99 "void gtk_drag_cancel GdkDrag* context")
(CFNC-3.99 "void gtk_drag_finish GdkDrag* context gboolean success guint32 time")
(CFNC-3.99 "void gtk_drag_set_icon_pixbuf GdkDrag* context GdkTexture* texture gint hot_x gint hot_y")
(CFNC-3.99 "char* gtk_drag_dest_find_target GtkWidget* widget GdkDrag* context GtkContentFormats* @target_list" 'const-return)
