...
;;; 3.98 (CINT "GDK_NOTHING" "GdkEventType")
(CINT "GDK_DELETE" "GdkEventType")
;;; 3.98 (CINT "GDK_DESTROY" "GdkEventType")
...
;;; 3.98.4? (CFNC "GdkEvent* gdk_event_copy GdkEvent* event")
;;; 3.96.0?? (CFNC "void gdk_event_free GdkEvent* event")
(CFNC "guint32 gdk_event_get_time GdkEvent* @event")
;;; 3.98.4? (CFNC "gboolean gdk_event_get_state GdkEvent* event GdkModifierType* [state]")
;;; 3.98.4? (CFNC "gboolean gdk_event_get_coords GdkEvent* event gdouble* [x_win] gdouble* [y_win]")
;;; 3.98.4? (CFNC "gboolean gdk_event_get_root_coords GdkEvent* event gdouble* [x_root] gdouble* [y_root]")
...
;;; 3.98.4? (CFNC "void gdk_set_show_events gboolean show_events")
;;; 3.98.4? (CFNC "gboolean gdk_get_show_events void")
...
;;; 3.98.4? (CCAST "GDK_KEYMAP(object)" "GdkKeymap*")
;;; 3.98.4? (CCHK "GDK_IS_KEYMAP(object)" "GdkKeymap*")
;;;;(CFNC "GType gdk_keymap_get_type void")
;;; 3.93.0 (CFNC "GdkKeymap* gdk_keymap_get_default void")
;;; 3.98.4? (CFNC "guint gdk_keymap_lookup_key GdkKeymap* keymap GdkKeymapKey* key")
...
;;; 3.98.3 (CFNC "gboolean gdk_keymap_get_entries_for_keyval GdkKeymap* keymap guint keyval GdkKeymapKey** [keys] gint* [n_keys]")
;;; 3.98.3 (CFNC "gboolean gdk_keymap_get_entries_for_keycode GdkKeymap* keymap guint hardware_keycode GdkKeymapKey** [keys] guint** [keyvals] gint* [n_entries]")
;;; 3.98.3 (CFNC "PangoDirection gdk_keymap_get_direction GdkKeymap* keymap")
...
;;; 3.98.4? (CFNC "gchar* gdk_utf8_to_string_target gchar* str" 'free)
...
;;; 3.98.3 (CINT "GDK_MOD1_MASK" "GdkModifierType")
;;; 3.98.3 (CINT "GDK_MOD2_MASK" "GdkModifierType")
;;; 3.98.3 (CINT "GDK_MOD3_MASK" "GdkModifierType")
;;; 3.98.3 (CINT "GDK_MOD4_MASK" "GdkModifierType")
;;; 3.98.3 (CINT "GDK_MOD5_MASK" "GdkModifierType")
...
;;; 3.98.2 (CINT "GDK_RELEASE_MASK" "GdkModifierType")
...
;;; 3.98.3 (CINT "GDK_GRAB_SUCCESS" "GdkGrabStatus")
;;; 3.98.3 (CINT "GDK_GRAB_ALREADY_GRABBED" "GdkGrabStatus")
;;; 3.98.3 (CINT "GDK_GRAB_INVALID_TIME" "GdkGrabStatus")
;;; 3.98.3 (CINT "GDK_GRAB_NOT_VIEWABLE" "GdkGrabStatus")
;;; 3.98.3 (CINT "GDK_GRAB_FROZEN" "GdkGrabStatus")
...
;;; 3.98 (CINT "GDK_DECOR_ALL" "GdkWMDecoration")
;;; 3.98 (CINT "GDK_DECOR_BORDER" "GdkWMDecoration")
;;; 3.98 (CINT "GDK_DECOR_RESIZEH" "GdkWMDecoration")
;;; 3.98 (CINT "GDK_DECOR_TITLE" "GdkWMDecoration")
;;; 3.98 (CINT "GDK_DECOR_MENU" "GdkWMDecoration")
;;; 3.98 (CINT "GDK_DECOR_MINIMIZE" "GdkWMDecoration")
;;; 3.98 (CINT "GDK_DECOR_MAXIMIZE" "GdkWMDecoration")
;;; 3.98 (CINT "GDK_FUNC_ALL" "GdkWMFunction")
;;; 3.98 (CINT "GDK_FUNC_RESIZE" "GdkWMFunction")
;;; 3.98 (CINT "GDK_FUNC_MOVE" "GdkWMFunction")
;;; 3.98 (CINT "GDK_FUNC_MINIMIZE" "GdkWMFunction")
;;; 3.98 (CINT "GDK_FUNC_MAXIMIZE" "GdkWMFunction")
;;; 3.98 (CINT "GDK_FUNC_CLOSE" "GdkWMFunction")
;;; 3.98 (CINT "GDK_GRAVITY_NORTH_WEST" "GdkGravity")
;;; 3.98 (CINT "GDK_GRAVITY_NORTH" "GdkGravity")
;;; 3.98 (CINT "GDK_GRAVITY_NORTH_EAST" "GdkGravity")
;;; 3.98 (CINT "GDK_GRAVITY_WEST" "GdkGravity")
;;; 3.98 (CINT "GDK_GRAVITY_CENTER" "GdkGravity")
;;; 3.98 (CINT "GDK_GRAVITY_EAST" "GdkGravity")
;;; 3.98 (CINT "GDK_GRAVITY_SOUTH_WEST" "GdkGravity")
;;; 3.98 (CINT "GDK_GRAVITY_SOUTH" "GdkGravity")
;;; 3.98 (CINT "GDK_GRAVITY_SOUTH_EAST" "GdkGravity")
;;; 3.98 (CINT "GDK_GRAVITY_STATIC" "GdkGravity")
...
;;; 3.98.2 (CCAST "GTK_ACCEL_GROUP(object)" "GtkAccelGroup*")
;;; 3.98.2 (CCHK "GTK_IS_ACCEL_GROUP(object)" "GtkAccelGroup*")
;;; 3.98.2 (CINT "GTK_ACCEL_VISIBLE" "GtkAccelFlags")
;;; 3.98.2 (CINT "GTK_ACCEL_LOCKED" "GtkAccelFlags")
;;; 3.98.2 (CINT "GTK_ACCEL_MASK" "GtkAccelFlags")
;;; 3.98.2 ;;;;(CFNC "GType gtk_accel_group_get_type void")
;;; 3.98.2 (CFNC "GtkAccelGroup* gtk_accel_group_new void")
;;; 3.98.2 (CFNC "void gtk_accel_group_lock GtkAccelGroup* accel_group")
;;; 3.98.2 (CFNC "void gtk_accel_group_unlock GtkAccelGroup* accel_group")
;;; 3.98.2 (CFNC "void gtk_accel_group_connect GtkAccelGroup* accel_group guint accel_key GdkModifierType accel_mods GtkAccelFlags accel_flags GClosure* @closure")
;;; 3.98.2 (CFNC "void gtk_accel_group_connect_by_path GtkAccelGroup* accel_group gchar* accel_path GClosure* @closure")
;;; 3.98.2 (CFNC "gboolean gtk_accel_group_disconnect GtkAccelGroup* accel_group GClosure* @closure")
;;; 3.98.2 (CFNC "gboolean gtk_accel_group_disconnect_key GtkAccelGroup* accel_group guint accel_key GdkModifierType accel_mods")
;;; 3.98.2 (CFNC "gboolean gtk_accel_groups_activate GObject* object guint accel_key GdkModifierType accel_mods")
;;; 3.98.2 (CFNC "GSList* gtk_accel_groups_from_object GObject* object")
;;; 3.98.2 (CFNC "GtkAccelKey* gtk_accel_group_find GtkAccelGroup* accel_group lambda3 func lambda_data @func_info")
;;; 3.98.2 (CFNC "GtkAccelGroup* gtk_accel_group_from_accel_closure GClosure* @closure")
;;; 3.98.2 (CFNC "gboolean gtk_accelerator_valid guint keyval GdkModifierType modifiers")
;;; 3.98.2 (CFNC "void gtk_accelerator_parse gchar* accelerator guint* [accelerator_key] GdkModifierType* [accelerator_mods]")
;;; 3.98.2 (CFNC "gchar* gtk_accelerator_name guint accelerator_key GdkModifierType accelerator_mods" 'free)
;;; 3.98.2 (CFNC "void gtk_accelerator_set_default_mod_mask GdkModifierType default_mod_mask")
;;; 2.91.1 (CFNC "guint gtk_accelerator_get_default_mod_mask void")
;;; 3.98.2 (CFNC "GtkAccelGroupEntry* gtk_accel_group_query GtkAccelGroup* accel_group guint accel_key GdkModifierType accel_mods guint* [n_entries]")
;;; 3.98.2 (CFNC "gboolean gtk_accel_group_activate GtkAccelGroup* accel_group GQuark accel_quark GObject* acceleratable guint accel_key GdkModifierType accel_mods")
...
;;; 3.98.2 (CFNC "GtkWidget* gtk_accel_label_get_accel_widget GtkAccelLabel* accel_label")
(CFNC "guint gtk_accel_label_get_accel_width GtkAccelLabel* accel_label")
;;; 3.98.2 (CFNC "void gtk_accel_label_set_accel_widget GtkAccelLabel* accel_label GtkWidget* accel_widget")
;;; 3.98.2 (CFNC "void gtk_accel_label_set_accel_closure GtkAccelLabel* accel_label GClosure* @closure")
(CFNC "gboolean gtk_accel_label_refetch GtkAccelLabel* accel_label")
;;; 3.98.2 (CFNC "void gtk_accel_map_add_entry gchar* accel_path guint accel_key GdkModifierType accel_mods")
;;; 3.98.2 (CFNC "gboolean gtk_accel_map_lookup_entry gchar* accel_path GtkAccelKey* key")
;;; 3.98.2 (CFNC "gboolean gtk_accel_map_change_entry gchar* accel_path guint accel_key GdkModifierType accel_mods gboolean replace")
;;; 3.98.2 (CFNC "void gtk_accel_map_load gchar* file_name")
;;; 3.98.2 (CFNC "void gtk_accel_map_save gchar* file_name")
;;; 3.98.2 (CFNC "void gtk_accel_map_foreach lambda_data @func_info GtkAccelMapForeach func")
;;; 3.98.2 (CFNC "void gtk_accel_map_load_fd gint fd")
;;; (CFNC "void gtk_accel_map_load_scanner GScanner* scanner")
;;; 3.98.2 (CFNC "void gtk_accel_map_save_fd gint fd")
;;; 3.98.2 (CFNC "void gtk_accel_map_add_filter gchar* filter_pattern")
;;; 3.98.2 (CFNC "void gtk_accel_map_foreach_unfiltered lambda_data @func_info GtkAccelMapForeach func")
...
;;; 3.98.3 (CFNC "GtkWidget* gtk_aspect_frame_new gchar* label gfloat xalign gfloat yalign gfloat ratio gboolean obey_child")
;;; 3.98.3 (CFNC "void gtk_aspect_frame_set GtkAspectFrame* aspect_frame gfloat xalign gfloat yalign gfloat ratio gboolean obey_child")
...
;;; 3.98.2 (CFNC "GtkBindingSet* gtk_binding_set_new gchar* set_name")
;;; 3.98.2 (CFNC "GtkBindingSet* gtk_binding_set_by_class gpointer object_class")
;;; 3.98.2 (CFNC "GtkBindingSet* gtk_binding_set_find gchar* set_name")
...
;;; 3.98.2 (CFNC "void gtk_binding_entry_remove GtkBindingSet* binding_set guint keyval GdkModifierType modifiers")
...
;;; 3.98.4? (CCAST "GTK_BIN(obj)" "GtkBin*")
;;; 3.98.4? (CCHK "GTK_IS_BIN(obj)" "GtkBin*")
;;;;(CFNC "GType gtk_bin_get_type void")
;;; 3.98.4? (CFNC "GtkWidget* gtk_bin_get_child GtkBin* bin")
...
;;; 3.98.0 (CFNC "void gtk_button_clicked GtkButton* button")
;;; (CFNC "void gtk_button_enter GtkButton* button")
;;; (CFNC "void gtk_button_leave GtkButton* button")
;;; 3.98.3 (CFNC "void gtk_button_set_relief GtkButton* button GtkReliefStyle newstyle")
;;; 3.98.3 (CFNC "GtkReliefStyle gtk_button_get_relief GtkButton* button")
...
;;; 3.98.4? (CINT "GTK_CALENDAR_SHOW_HEADING" "GtkCalendarDisplayOptions")
;;; 3.98.4? (CINT "GTK_CALENDAR_SHOW_DAY_NAMES" "GtkCalendarDisplayOptions")
;;; 3.98.4? (CINT "GTK_CALENDAR_NO_MONTH_CHANGE" "GtkCalendarDisplayOptions")
;;; 3.98.4? (CINT "GTK_CALENDAR_SHOW_WEEK_NUMBERS" "GtkCalendarDisplayOptions")
...
;;; 3.98.4? (CFNC "void gtk_calendar_get_date GtkCalendar* calendar guint* [year] guint* [month] guint* [day]")
...
;;; 3.98.1 (CCAST "GTK_CHECK_MENU_ITEM(obj)" "GtkCheckMenuItem*")
;;; 3.98.1 (CCHK "GTK_IS_CHECK_MENU_ITEM(obj)" "GtkCheckMenuItem*")
;;;;(CFNC "GType gtk_check_menu_item_get_type void")
;;; 3.98.1 (CFNC "GtkWidget* gtk_check_menu_item_new void")
;;; 3.98.1 (CFNC "GtkWidget* gtk_check_menu_item_new_with_label gchar* label") ; null label => segfault
;;; 3.98.1 (CFNC "GtkWidget* gtk_check_menu_item_new_with_mnemonic gchar* label")
;;; 3.98.1 (CFNC "void gtk_check_menu_item_set_active GtkCheckMenuItem* check_menu_item gboolean is_active")
;;; 3.98.1 (CFNC "gboolean gtk_check_menu_item_get_active GtkCheckMenuItem* check_menu_item")
;;; 3.98.1 (CFNC "void gtk_check_menu_item_toggled GtkCheckMenuItem* check_menu_item")
;;; 3.98.1 (CFNC "void gtk_check_menu_item_set_inconsistent GtkCheckMenuItem* check_menu_item gboolean setting")
;;; 3.98.1 (CFNC "gboolean gtk_check_menu_item_get_inconsistent GtkCheckMenuItem* check_menu_item")
...
;;; 3.98.4? (CCAST "GTK_CONTAINER(obj)" "GtkContainer*")
;;; 3.98.4? (CCHK "GTK_IS_CONTAINER(obj)" "GtkContainer*")
...
;;; 3.98.4? (CFNC "void gtk_container_add GtkContainer* container GtkWidget* widget")
;;; 3.98.4? (CFNC "void gtk_container_remove GtkContainer* container GtkWidget* widget")
...
;;; 3.98.4? (CFNC "void gtk_container_foreach GtkContainer* container GtkCallback func lambda_data @func_info")
;;; 3.98.4? (CFNC "GList* gtk_container_get_children GtkContainer* container") ; FREE (g_list_free)
...
;;; 3.98.4 (CFNC "gint gtk_dialog_run GtkDialog* dialog")
;;; 3.98.4? (CINT "GTK_DEST_DEFAULT_MOTION" "GtkDestDefaults")
;;; 3.98.4? (CINT "GTK_DEST_DEFAULT_HIGHLIGHT" "GtkDestDefaults")
;;; 3.98.4? (CINT "GTK_DEST_DEFAULT_DROP" "GtkDestDefaults")
;;; 3.98.4? (CINT "GTK_DEST_DEFAULT_ALL" "GtkDestDefaults")
...
;;; 3.98 (CFNC "void gtk_drag_highlight GtkWidget* widget")
;;; 3.98 (CFNC "void gtk_drag_unhighlight GtkWidget* widget")
...
;;; 3.98 (CFNC "void gtk_drag_dest_unset GtkWidget* widget")
...
;;; 3.98.1 (CFNC "void gtk_drag_source_unset GtkWidget* widget")
...
;;; 3.98 (CFNC "gboolean gtk_drag_check_threshold GtkWidget* widget gint start_x gint start_y gint current_x gint current_y")
...
;;; 3.98.3 (CINT "GTK_RELIEF_NORMAL" "GtkReliefStyle")
;;; 3.92.1?? (CINT "GTK_RELIEF_HALF" "GtkReliefStyle")
;;; 3.98.3 (CINT "GTK_RELIEF_NONE" "GtkReliefStyle")
...
;;; 3.98.3 (CINT "GTK_SHADOW_NONE" "GtkShadowType")
;;; 3.98.3 (CINT "GTK_SHADOW_IN" "GtkShadowType")
;;; 3.98.3 (CINT "GTK_SHADOW_OUT" "GtkShadowType")
;;; 3.98.3 (CINT "GTK_SHADOW_ETCHED_IN" "GtkShadowType")
;;; 3.98.3 (CINT "GTK_SHADOW_ETCHED_OUT" "GtkShadowType")
...
;;; 3.98.0 (CINT "GTK_TOOLBAR_ICONS" "GtkToolbarStyle")
;;; 3.98.0 (CINT "GTK_TOOLBAR_TEXT" "GtkToolbarStyle")
;;; 3.98.0 (CINT "GTK_TOOLBAR_BOTH" "GtkToolbarStyle")
;;; 3.98.0 (CINT "GTK_TOOLBAR_BOTH_HORIZ" "GtkToolbarStyle")
...
;;; 3.98 (CINT "GTK_WIN_POS_NONE" "GtkWindowPosition")
;;; 3.98 (CINT "GTK_WIN_POS_CENTER" "GtkWindowPosition")
;;; 3.98 (CINT "GTK_WIN_POS_MOUSE" "GtkWindowPosition")
;;; 3.98 (CINT "GTK_WIN_POS_CENTER_ALWAYS" "GtkWindowPosition")
;;; 3.98 (CINT "GTK_WIN_POS_CENTER_ON_PARENT" "GtkWindowPosition")
;;; 3.98 (CINT "GTK_WINDOW_TOPLEVEL" "GtkWindowType")
;;; 3.98 (CINT "GTK_WINDOW_POPUP" "GtkWindowType")
...
;;; 3.98.3 (CFNC "void gtk_frame_set_shadow_type GtkFrame* frame GtkShadowType type")
;;; 3.98.3 (CFNC "GtkShadowType gtk_frame_get_shadow_type GtkFrame* frame")
...
;;; 3.98.4? (CFNC "gboolean gtk_im_context_filter_keypress GtkIMContext* context GdkEventKey* event")
...
;;; 3.98.4? (CFNC "gint gtk_events_pending void")
...
;;; 3.98.3 (CFNC "GdkEvent* gtk_get_current_event void")
;;; 3.98.3 (CFNC "guint32 gtk_get_current_event_time void")
;;; 3.98.3 (CFNC "gboolean gtk_get_current_event_state GdkModifierType* [state]")
...
;;; 3.98.4? (CFNC "GtkWidget* gtk_menu_bar_new void")
...
;;; 3.98.1 (CFNC "GtkWidget* gtk_menu_item_new void")
;;; 3.98.1 (CFNC "GtkWidget* gtk_menu_item_new_with_label gchar* label") ; null -> segfault
;;; 3.98.1 (CFNC "GtkWidget* gtk_menu_item_new_with_mnemonic gchar* label")
;;; 3.98.1 (CFNC "void gtk_menu_item_set_submenu GtkMenuItem* menu_item GtkWidget* submenu")
;;; 3.98.1 (CFNC "GtkWidget* gtk_menu_item_get_submenu GtkMenuItem* menu_item")
;;; (CFNC "void gtk_menu_item_remove_submenu GtkMenuItem* menu_item") ; out 2.11.3
;;; 3.98.1 (CFNC "void gtk_menu_item_select GtkMenuItem* menu_item")
;;; 3.98.1 (CFNC "void gtk_menu_item_deselect GtkMenuItem* menu_item")
;;; 3.98.1 (CFNC "void gtk_menu_item_activate GtkMenuItem* menu_item")
;;; 3.98.1 (CFNC "void gtk_menu_item_toggle_size_request GtkMenuItem* menu_item gint* requisition")
;;; 3.98.1 (CFNC "void gtk_menu_item_toggle_size_allocate GtkMenuItem* menu_item gint allocation")
...
;;; 3.98.1 (CFNC "void gtk_menu_item_set_accel_path GtkMenuItem* menu_item gchar* accel_path")
;;; 3.98.1 (CCAST "GTK_MENU_SHELL(obj)" "GtkMenuShell*")
;;; 3.98.1 (CCHK "GTK_IS_MENU_SHELL(obj)" "GtkMenuShell*")
;;;;(CFNC "GType gtk_menu_shell_get_type void")
;;; 3.98.1 (CFNC "void gtk_menu_shell_append GtkMenuShell* menu_shell GtkWidget* child")
;;; 3.98.1 (CFNC "void gtk_menu_shell_prepend GtkMenuShell* menu_shell GtkWidget* child")
;;; 3.98.1 (CFNC "void gtk_menu_shell_insert GtkMenuShell* menu_shell GtkWidget* child gint position")
;;; 3.98.1 (CFNC "void gtk_menu_shell_deactivate GtkMenuShell* menu_shell")
;;; 3.98.1 (CFNC "void gtk_menu_shell_select_item GtkMenuShell* menu_shell GtkWidget* menu_item")
;;; 3.98.1 (CFNC "void gtk_menu_shell_deselect GtkMenuShell* menu_shell")
;;; 3.98.1 (CFNC "void gtk_menu_shell_activate_item GtkMenuShell* menu_shell GtkWidget* menu_item gboolean force_deactivate")
...
;;; 3.98.4 (CFNC "void gtk_paned_add1 GtkPaned* paned GtkWidget* child")
;;; 3.98.4 (CFNC "void gtk_paned_add2 GtkPaned* paned GtkWidget* child")
;;; 3.98.4 (CFNC "void gtk_paned_pack1 GtkPaned* paned GtkWidget* child gboolean resize gboolean shrink")
;;; 3.98.4 (CFNC "void gtk_paned_pack2 GtkPaned* paned GtkWidget* child gboolean resize gboolean shrink")
;;; 3.98.4 (CFNC "gint gtk_paned_get_position GtkPaned* paned")
;;; 3.98.4 (CFNC "void gtk_paned_set_position GtkPaned* paned gint position")
...
;;; 3.98 (CCAST "GTK_RADIO_MENU_ITEM(obj)" "GtkRadioMenuItem*")
;;; 3.98 (CCHK "GTK_IS_RADIO_MENU_ITEM(obj)" "GtkRadioMenuItem*")
;;;;(CFNC "GType gtk_radio_menu_item_get_type void")
;;; 3.98.1 (CFNC "GtkWidget* gtk_radio_menu_item_new GSList* @group")
;;; 3.98.1 (CFNC "GtkWidget* gtk_radio_menu_item_new_with_label GSList* @group gchar* label")
;;; 3.98.1 (CFNC "GtkWidget* gtk_radio_menu_item_new_with_mnemonic GSList* @group gchar* label")
;;; 3.98 (CFNC "GSList* gtk_radio_menu_item_get_group GtkRadioMenuItem* radio_menu_item")
;;; 3.98 (CFNC "void gtk_radio_menu_item_set_group GtkRadioMenuItem* radio_menu_item GSList* @group")
...
;;; 3.98.3 (CFNC "void gtk_scrolled_window_set_shadow_type GtkScrolledWindow* scrolled_window GtkShadowType type")
;;; 3.98.3 (CFNC "GtkShadowType gtk_scrolled_window_get_shadow_type GtkScrolledWindow* scrolled_window")
...
;;; 3.98 (CFNC "GtkSelectionData* gtk_selection_data_copy GtkSelectionData* data")
;;; 3.98 (CFNC "void gtk_selection_data_free GtkSelectionData* data")
(CCAST "GTK_SEPARATOR(obj)" "GtkSeparator*")
(CCHK "GTK_IS_SEPARATOR(obj)" "GtkSeparator*")
;;;;(CFNC "GType gtk_separator_get_type void")
;;; 3.98.1 (CCAST "GTK_SEPARATOR_MENU_ITEM(obj)" "GtkSeparatorMenuItem*")
;;; 3.98.1 (CCHK "GTK_IS_SEPARATOR_MENU_ITEM(obj)" "GtkSeparatorMenuItem*")
;;;;(CFNC "GType gtk_separator_menu_item_get_type void")
;;; 3.98.1 (CFNC "GtkWidget* gtk_separator_menu_item_new void")
...
;;; 3.98 ;(CFNC "gboolean gtk_rc_property_parse_color GParamSpec* pspec GString* gstring GValue* property_value")
;;; 3.98 ;(CFNC "gboolean gtk_rc_property_parse_enum GParamSpec* pspec GString* gstring GValue* property_value")
;;; 3.98 ;(CFNC "gboolean gtk_rc_property_parse_flags GParamSpec* pspec GString* gstring GValue* property_value")
;;; 3.98 ;(CFNC "gboolean gtk_rc_property_parse_requisition GParamSpec* pspec GString* gstring GValue* property_value")
;;; 3.98 ;(CFNC "gboolean gtk_rc_property_parse_border GParamSpec* pspec GString* gstring GValue* property_value")
...
;;; 3.98.4 (CFNC "GList* gtk_text_child_anchor_get_widgets GtkTextChildAnchor* anchor")
...
;;; 3.98.4? (CFNC "void gtk_text_view_set_border_window_size GtkTextView* text_view GtkTextWindowType type gint size")
;;; 3.98.4? (CFNC "gint gtk_text_view_get_border_window_size GtkTextView* text_view GtkTextWindowType type")
...
;;; 3.98 (CCAST "GTK_TOOLBAR(obj)" "GtkToolbar*")
;;; 3.98 (CCHK "GTK_IS_TOOLBAR(obj)" "GtkToolbar*")
...
;;; 3.98.4? (CFNC "GtkWidget* gtk_toolbar_new void")
...
;;; 3.98 (CFNC "void gtk_toolbar_set_style GtkToolbar* toolbar GtkToolbarStyle style")
;;; 3.98 (CFNC "void gtk_toolbar_unset_style GtkToolbar* toolbar")
...
;;; 3.98 (CFNC "GtkToolbarStyle gtk_toolbar_get_style GtkToolbar* toolbar")
...
;;; 3.98 (CFNC "gboolean gtk_tree_drag_source_drag_data_get GtkTreeDragSource* drag_source GtkTreePath* path GtkSelectionData* selection_data")
;;; 3.98 (CCAST "GTK_TREE_DRAG_DEST(obj)" "GtkTreeDragDest*")
;;; 3.98 (CCHK "GTK_IS_TREE_DRAG_DEST(obj)" "GtkTreeDragDest*")
;;;;(CFNC "GType gtk_tree_drag_dest_get_type void")
;;; 3.98 (CFNC "gboolean gtk_tree_drag_dest_drag_data_received GtkTreeDragDest* drag_dest GtkTreePath* dest GtkSelectionData* selection_data")
;;; 3.98 (CFNC "gboolean gtk_tree_drag_dest_row_drop_possible GtkTreeDragDest* drag_dest GtkTreePath* dest_path GtkSelectionData* selection_data")
;;; 3.98 (CFNC "gboolean gtk_tree_set_row_drag_data GtkSelectionData* selection_data GtkTreeModel* tree_model GtkTreePath* path")
;;; 3.98 (CFNC "gboolean gtk_tree_get_row_drag_data GtkSelectionData* selection_data GtkTreeModel** [tree_model] GtkTreePath** [path]")
...
;;; 3.98 (CFNC "void gtk_tree_view_unset_rows_drag_dest GtkTreeView* tree_view")
;;; 3.98 (CFNC "void gtk_tree_view_set_drag_dest_row GtkTreeView* tree_view GtkTreePath* path GtkTreeViewDropPosition pos")
;;; 3.98 (CFNC "void gtk_tree_view_get_drag_dest_row GtkTreeView* tree_view GtkTreePath** [path] GtkTreeViewDropPosition* [pos]")
...
;;; 3.98.3 (CFNC "void gtk_viewport_set_shadow_type GtkViewport* viewport GtkShadowType type")
;;; 3.98.3 (CFNC "GtkShadowType gtk_viewport_get_shadow_type GtkViewport* viewport")
...
;;; 3.98.4 (CFNC "void gtk_widget_destroy GtkWidget* widget")
;;; 3.98.4 (CFNC "void gtk_widget_destroyed GtkWidget* widget GtkWidget** [widget_pointer]")
...
;;; 3.98.2 (CFNC "void gtk_widget_add_accelerator GtkWidget* widget gchar* accel_signal GtkAccelGroup* accel_group guint accel_key GdkModifierType accel_mods GtkAccelFlags accel_flags")
;;; 3.98.2 (CFNC "gboolean gtk_widget_remove_accelerator GtkWidget* widget GtkAccelGroup* accel_group guint accel_key GdkModifierType accel_mods")
;;; 3.98.2 (CFNC "GList* gtk_widget_list_accel_closures GtkWidget* widget") ; FREE (g_list_free)
(CFNC "gboolean gtk_widget_mnemonic_activate GtkWidget* widget gboolean group_cycling")
;;; 3.98.4? (CFNC "gboolean gtk_widget_event GtkWidget* widget GdkEvent* event")
...
;;; 3.98.2 (CFNC "void gtk_widget_set_accel_path GtkWidget* widget gchar* accel_path GtkAccelGroup* accel_group")
...
;;; 3.98.4 (CFNC "gboolean gtk_widget_translate_coordinates GtkWidget* src_widget GtkWidget* dest_widget gint src_x gint src_y gint* [dest_x] gint* [dest_y]")
...
;;; 3.98.2 (CFNC "gboolean gtk_widget_can_activate_accel GtkWidget* widget guint signal_id")
...
;;; 3.98 now void arg (CFNC "GtkWidget* gtk_window_new GtkWindowType type")
...
;;; 3.98.2 (CFNC "void gtk_window_add_accel_group GtkWindow* window GtkAccelGroup* accel_group")
;;; 3.98.2 (CFNC "void gtk_window_remove_accel_group GtkWindow* window GtkAccelGroup* accel_group")
;;; 3.98 (CFNC "void gtk_window_set_position GtkWindow* window GtkWindowPosition position")
...
;;; 3.98.2 (CFNC "void gtk_window_add_mnemonic GtkWindow* window guint keyval GtkWidget* target")
;;; 3.98.2 (CFNC "void gtk_window_remove_mnemonic GtkWindow* window guint keyval GtkWidget* target")
;;; 3.98.2 (CFNC "gboolean gtk_window_mnemonic_activate GtkWindow* window guint keyval GdkModifierType modifier")
;;; 3.98.2 (CFNC "void gtk_window_set_mnemonic_modifier GtkWindow* window GdkModifierType modifier")
;;; 3.98.2 (CFNC "GdkModifierType gtk_window_get_mnemonic_modifier GtkWindow* window")
(CFNC "void gtk_window_present GtkWindow* window")
;;; 3.98 (CFNC "void gtk_window_iconify GtkWindow* window")
;;; 3.98 (CFNC "void gtk_window_deiconify GtkWindow* window")
;;; 3.98 (CFNC "void gtk_window_stick GtkWindow* window")
;;; 3.98 (CFNC "void gtk_window_unstick GtkWindow* window")
(CFNC "void gtk_window_maximize GtkWindow* window")
(CFNC "void gtk_window_unmaximize GtkWindow* window")
;;; 3.98 (CFNC "void gtk_window_begin_move_drag GtkWindow* window gint button gint root_x gint root_y guint32 timestamp")
...
;;; 3.98.1 (CFNC "void gtk_menu_shell_select_first GtkMenuShell* menu_shell gboolean search_sensitive")
...
;;; 3.98.4? (CCAST "GDK_EVENT_ANY(obj)" "GdkEventAny*")
...
;;; 3.98.4? (CCAST "GDK_EVENT_KEY(obj)" "GdkEventKey*")
...
;;; 3.98.4? (CFNC "void gtk_calendar_set_display_options GtkCalendar* calendar GtkCalendarDisplayOptions flags")
;;; 3.98.4? (CFNC "GtkCalendarDisplayOptions gtk_calendar_get_display_options GtkCalendar* calendar")
;;; 3.98.1 (CFNC "void gtk_check_menu_item_set_draw_as_radio GtkCheckMenuItem* check_menu_item gboolean draw_as_radio")
;;; 3.98.1 (CFNC "gboolean gtk_check_menu_item_get_draw_as_radio GtkCheckMenuItem* check_menu_item")
...
;;; 3.98 (CFNC "void gtk_toolbar_insert GtkToolbar* toolbar GtkToolItem* item gint pos")
;;; 3.98 (CFNC "gint gtk_toolbar_get_item_index GtkToolbar* toolbar GtkToolItem* item")
;;; 3.98 (CFNC "gint gtk_toolbar_get_n_items GtkToolbar* toolbar")
;;; 3.98 (CFNC "GtkToolItem* gtk_toolbar_get_nth_item GtkToolbar* toolbar gint n")
;;; 3.98 (CFNC "void gtk_toolbar_set_show_arrow GtkToolbar* toolbar gboolean show_arrow")
;;; 3.98 (CFNC "gboolean gtk_toolbar_get_show_arrow GtkToolbar* toolbar")
;;; 3.89 (CFNC "GtkReliefStyle gtk_toolbar_get_relief_style GtkToolbar* toolbar")
;;; 3.98 (CFNC "gint gtk_toolbar_get_drop_index GtkToolbar* toolbar gint x gint y")
...
;;; 3.98 (CCAST "GTK_RADIO_TOOL_BUTTON(obj)" "GtkRadioToolButton*")
;;; 3.98 (CCHK "GTK_IS_RADIO_TOOL_BUTTON(obj)" "GtkRadioToolButton*")
;;; (CCAST "GTK_RADIO_ACTION(obj)" "GtkRadioAction*")
;;; (CCHK "GTK_IS_RADIO_ACTION(obj)" "GtkRadioAction*")
;;; 3.98 (CCAST "GTK_SEPARATOR_TOOL_ITEM(obj)" "GtkSeparatorToolItem*")
;;; 3.98 (CCHK "GTK_IS_SEPARATOR_TOOL_ITEM(obj)" "GtkSeparatorToolItem*")
;;; (CCAST "GTK_TOGGLE_ACTION(obj)" "GtkToggleAction*")
;;; (CCHK "GTK_IS_TOGGLE_ACTION(obj)" "GtkToggleAction*")
;;; 3.98 (CCAST "GTK_TOGGLE_TOOL_BUTTON(obj)" "GtkToggleToolButton*")
;;; 3.98 (CCHK "GTK_IS_TOGGLE_TOOL_BUTTON(obj)" "GtkToggleToolButton*")
...
;;; 3.98 (CCAST "GTK_ICON_THEME(obj)" "GtkIconTheme*")
;;; 3.98 (CCHK "GTK_IS_ICON_THEME(obj)" "GtkIconTheme*")
;;; 3.98 (CCAST "GTK_TOOL_BUTTON(obj)" "GtkToolButton*")
;;; 3.98 (CCHK "GTK_IS_TOOL_BUTTON(obj)" "GtkToolButton*")
;;; 3.98 (CCAST "GTK_TOOL_ITEM(o)" "GtkToolItem*")
;;; 3.98 (CCHK "GTK_IS_TOOL_ITEM(o)" "GtkToolItem*")
...
;;; 3.98 (CINT "GTK_ICON_LOOKUP_NO_SVG" "GtkIconLookupFlags")
;;; 3.98 (CINT "GTK_ICON_LOOKUP_FORCE_SVG" "GtkIconLookupFlags")
;;; 3.98 (CINT "GTK_ICON_LOOKUP_USE_BUILTIN" "GtkIconLookupFlags")
;;; 3.98 (CINT "GTK_ICON_LOOKUP_GENERIC_FALLBACK" "GtkIconLookupFlags")
...
;;; 3.98 (CFNC "GtkToolItem* gtk_radio_tool_button_new GSList* @group") 
...
;;; changed 2.3.1
;;; 3.98 (CFNC "GtkToolItem* gtk_radio_tool_button_new_from_widget GtkRadioToolButton* group") 
...
;;; 3.98 (CFNC "GSList* gtk_radio_tool_button_get_group GtkRadioToolButton* button") 
;;; 3.98 (CFNC "void gtk_radio_tool_button_set_group GtkRadioToolButton* button GSList* @group")
...
;;; 3.98 (CFNC "GtkToolItem* gtk_separator_tool_item_new void") 
;;; 3.98 (CFNC "gboolean gtk_separator_tool_item_get_draw GtkSeparatorToolItem* item")
;;; 3.98 (CFNC "void gtk_separator_tool_item_set_draw GtkSeparatorToolItem* tool_item gboolean draw")
...
;;; 3.98 (CFNC "GtkToolItem* gtk_toggle_tool_button_new void") 
;;; (CFNC "GtkToolItem* gtk_toggle_tool_button_new_from_stock gchar* stock_id") 
;;; 3.98 (CFNC "void gtk_toggle_tool_button_set_active GtkToggleToolButton* button gboolean is_active") 
;;; 3.98 (CFNC "gboolean gtk_toggle_tool_button_get_active GtkToggleToolButton* button") 
...
;;; 3.98 ;(CFNC "void gtk_icon_theme_set_search_path GtkIconTheme* icon_theme gchar** path gint n_elements") 
;;; 3.98 (CFNC "void gtk_icon_theme_get_search_path GtkIconTheme* icon_theme gchar*** [path] gint* [n_elements]") 
;;; 3.98 (CFNC "void gtk_icon_theme_append_search_path GtkIconTheme* icon_theme gchar* path") 
;;; 3.98 (CFNC "void gtk_icon_theme_prepend_search_path GtkIconTheme* icon_theme gchar* path") 
;;; 3.98 (CFNC "void gtk_icon_theme_set_custom_theme GtkIconTheme* icon_theme gchar* theme_name") 
;;; 3.98 (CFNC "gboolean gtk_icon_theme_has_icon GtkIconTheme* icon_theme gchar* icon_name") 
;;; 3.98 (CFNC "GtkIconInfo* gtk_icon_theme_lookup_icon GtkIconTheme* icon_theme gchar* icon_name gint size GtkIconLookupFlags flags") 
;;; 3.98 (CFNC "GdkPixbuf* gtk_icon_theme_load_icon GtkIconTheme* icon_theme gchar* icon_name gint size GtkIconLookupFlags flags GError** [error]") 
;;; 3.98 (CFNC "GList* gtk_icon_theme_list_icons GtkIconTheme* icon_theme gchar* context") 
;;; 3.98 (CFNC "char* gtk_icon_theme_get_example_icon_name GtkIconTheme* icon_theme") 
;;; 3.98 (CFNC "gboolean gtk_icon_theme_rescan_if_needed GtkIconTheme* icon_theme") 
;;; 3.98 ;;; 3.13.4 (CFNC "void gtk_icon_theme_add_builtin_icon gchar* icon_name gint size GdkPixbuf* pixbuf") 
...
;;; 3.98.4? (CFNC "gint gtk_icon_info_get_base_size GtkIconInfo* icon_info") 
;;; 3.98.4? (CFNC "gchar* gtk_icon_info_get_filename GtkIconInfo* icon_info") 
;;; 3.13.4 (CFNC "GdkPixbuf* gtk_icon_info_get_builtin_pixbuf GtkIconInfo* icon_info") 
;;; 3.98.4? (CFNC "GdkPixbuf* gtk_icon_info_load_icon GtkIconInfo* icon_info GError** [error]") 
...
;;; 3.98 (CFNC "GtkToolItem* gtk_tool_button_new GtkWidget* @icon_widget gchar* label") 
;;; (CFNC "GtkToolItem* gtk_tool_button_new_from_stock gchar* stock_id") 
;;; 3.98 (CFNC "void gtk_tool_button_set_label GtkToolButton* button gchar* label") 
;;; 3.98 (CFNC "gchar* gtk_tool_button_get_label GtkToolButton* button") 
;;; 3.98 (CFNC "void gtk_tool_button_set_use_underline GtkToolButton* button gboolean use_underline") 
;;; 3.98 (CFNC "gboolean gtk_tool_button_get_use_underline GtkToolButton* button") 
...
;;; 3.98 (CFNC "void gtk_tool_button_set_icon_widget GtkToolButton* button GtkWidget* @icon_widget") 
;;; 3.98 (CFNC "GtkWidget* gtk_tool_button_get_icon_widget GtkToolButton* button") 
;;; 3.98 (CFNC "void gtk_tool_button_set_label_widget GtkToolButton* button GtkWidget* @label_widget") 
;;; 3.98 (CFNC "GtkWidget* gtk_tool_button_get_label_widget GtkToolButton* button") 
;;; 3.98 ;;;;(CFNC "GType gtk_tool_item_get_type void") 
;;; 3.98 (CFNC "GtkToolItem* gtk_tool_item_new void") 
;;; 3.98 (CFNC "void gtk_tool_item_set_homogeneous GtkToolItem* tool_item gboolean homogeneous") 
;;; 3.98 (CFNC "gboolean gtk_tool_item_get_homogeneous GtkToolItem* tool_item") 
;;; 3.98 (CFNC "void gtk_tool_item_set_expand GtkToolItem* tool_item gboolean expand") 
;;; 3.98 (CFNC "gboolean gtk_tool_item_get_expand GtkToolItem* tool_item") 
;;; 3.98 ;;;(CFNC "void gtk_tool_item_set_pack_end GtkToolItem* tool_item gboolean pack_end") 
;;; 3.98 ;;;(CFNC "gboolean gtk_tool_item_get_pack_end GtkToolItem* tool_item") 
;;; 3.98 ;;; out 2.11.6 (CFNC "void gtk_tool_item_set_tooltip GtkToolItem* tool_item GtkTooltips* tooltips gchar* tip_text gchar* tip_private") 
;;; 3.98 ;;; 3.91.1 (CFNC "void gtk_tool_item_set_use_drag_window GtkToolItem* toolitem gboolean use_drag_window") 
;;; 3.98 ;;; 3.91.1 (CFNC "gboolean gtk_tool_item_get_use_drag_window GtkToolItem* toolitem") 
;;; 3.98 (CFNC "void gtk_tool_item_set_visible_horizontal GtkToolItem* toolitem gboolean visible_horizontal") 
;;; 3.98 (CFNC "gboolean gtk_tool_item_get_visible_horizontal GtkToolItem* toolitem") 
;;; 3.98 (CFNC "void gtk_tool_item_set_visible_vertical GtkToolItem* toolitem gboolean visible_vertical") 
;;; 3.98 (CFNC "gboolean gtk_tool_item_get_visible_vertical GtkToolItem* toolitem") 
;;; 3.98 (CFNC "gboolean gtk_tool_item_get_is_important GtkToolItem* tool_item") 
;;; 3.98 (CFNC "void gtk_tool_item_set_is_important GtkToolItem* tool_item gboolean is_important")
;;; 3.98 ;;; (CFNC "GtkIconSize gtk_tool_item_get_icon_size GtkToolItem* tool_item") 
;;; 3.98 (CFNC "GtkOrientation gtk_tool_item_get_orientation GtkToolItem* tool_item") 
;;; 3.98 (CFNC "GtkToolbarStyle gtk_tool_item_get_toolbar_style GtkToolItem* tool_item") 
;;; 3.89 (CFNC "GtkReliefStyle gtk_tool_item_get_relief_style GtkToolItem* tool_item") 
;;; 3.98.1 (CFNC "GtkWidget* gtk_tool_item_retrieve_proxy_menu_item GtkToolItem* tool_item") 
;;; 3.98.1 (CFNC "GtkWidget* gtk_tool_item_get_proxy_menu_item GtkToolItem* tool_item gchar* menu_item_id") 
;;; 3.98.1 (CFNC "void gtk_tool_item_set_proxy_menu_item GtkToolItem* @tool_item gchar* menu_item_id GtkWidget* @menu_item") 
...
;;; 3.98.1 (CFNC "void gtk_menu_shell_cancel GtkMenuShell* menu_shell")
...
;;; 3.98 (CFNC "void gtk_window_set_accept_focus GtkWindow* window gboolean setting")
;;; 3.98 (CFNC "gboolean gtk_window_get_accept_focus GtkWindow* window")

(CFNC "gpointer g_list_nth_data GList* list guint n")

;;; 3.98.2 (CCAST "GTK_ACCEL_MAP(obj)" "GtkAccelMap")
;;; 3.98.2 (CCHK "GTK_IS_ACCEL_MAP(obj)" "GtkAccelMap")

;;;;(CFNC "GType gtk_accel_map_get_type void")
;;; 3.98.2 (CFNC "GtkAccelMap* gtk_accel_map_get void")
(CFNC "void gtk_combo_box_popup GtkComboBox* combo_box")
(CFNC "void gtk_combo_box_popdown GtkComboBox* combo_box")
;;; 3.98 (CFNC "GtkWidget* gtk_radio_menu_item_new_from_widget GtkRadioMenuItem* group")
;;; 3.98 (CFNC "GtkWidget* gtk_radio_menu_item_new_with_mnemonic_from_widget GtkRadioMenuItem* group gchar* label")
;;; 3.98 (CFNC "GtkWidget* gtk_radio_menu_item_new_with_label_from_widget GtkRadioMenuItem* group gchar* label")
...
;;; 3.98 (CFNC "gboolean gtk_window_activate_key GtkWindow* window GdkEventKey* event")
;;; 3.98 (CFNC "gboolean gtk_window_propagate_key_event GtkWindow* window GdkEventKey* event")
...
;;; 3.98 (CFNC "void gtk_drag_dest_add_text_targets GtkWidget* widget")
;;; 3.98.1 (CFNC "void gtk_drag_source_add_text_targets GtkWidget* widget")
...
;;; 3.98 (CFNC "gint* gtk_icon_theme_get_icon_sizes GtkIconTheme* icon_theme gchar* icon_name") ; FREE
...
;;; 3.98 (CFNC "void gtk_window_set_focus_on_map GtkWindow* window gboolean setting")
;;; 3.98 (CFNC "gboolean gtk_window_get_focus_on_map GtkWindow* window")
...
;;; actually 2.5.3 here
;;; 3.98 (CFNC "void gtk_tool_item_rebuild_menu GtkToolItem* tool_item")
...
;;; 3.98.1 (CCAST "GTK_MENU_TOOL_BUTTON(obj)" "GtkMenuToolButton*")
;;; 3.98.1 (CCHK "GTK_IS_MENU_TOOL_BUTTON(obj)" "GtkMenuToolButton*")

;;;;(CFNC "GType gtk_menu_tool_button_get_type void")
;;; 3.98.1 (CFNC "GtkToolItem* gtk_menu_tool_button_new GtkWidget* @icon_widget gchar* label")
;;; (CFNC "GtkToolItem* gtk_menu_tool_button_new_from_stock gchar* stock_id")
;;; 3.98.1 (CFNC "void gtk_menu_tool_button_set_menu GtkMenuToolButton* button GtkWidget* menu")
;;; 3.98.1 (CFNC "GtkWidget* gtk_menu_tool_button_get_menu GtkMenuToolButton* button")
...
;;; 3.98 (CFNC "void gtk_drag_dest_add_image_targets GtkWidget* widget")
;;; 3.98 (CFNC "void gtk_drag_dest_add_uri_targets GtkWidget* widget")
;;; 3.98.1 (CFNC "void gtk_drag_source_add_image_targets GtkWidget* widget")
;;; 3.98.1 (CFNC "void gtk_drag_source_add_uri_targets GtkWidget* widget")
...
;;; 3.98 (CFNC "gboolean gtk_selection_data_targets_include_image GtkSelectionData* selection_data gboolean writable")
...
;;; 3.98.1 (CFNC "void gtk_drag_source_set_icon_name GtkWidget* widget gchar* icon_name" 'const)
...
;;; 3.98 (CFNC "void gtk_icon_view_unset_model_drag_dest GtkIconView* icon_view")
...
;;; 3.98 (CFNC "void gtk_icon_view_set_drag_dest_item GtkIconView* icon_view GtkTreePath* path GtkIconViewDropPosition pos")
;;; 3.98 (CFNC "void gtk_icon_view_get_drag_dest_item GtkIconView* icon_view GtkTreePath** [path] GtkIconViewDropPosition* [pos]")
...
;;; 3.98.1 (CFNC "gboolean gtk_menu_shell_get_take_focus GtkMenuShell* menu_shell")
;;; 3.98.1 (CFNC "void gtk_menu_shell_set_take_focus GtkMenuShell* menu_shell gboolean take_focus")
...
;;; 3.98 (CFNC "void gtk_tool_button_set_icon_name GtkToolButton* button gchar* icon_name" 'const)
;;; 3.98 (CFNC "gchar* gtk_tool_button_get_icon_name GtkToolButton* button" 'const-return)
...
;;; 3.98.0 (CINT "GTK_FILE_CHOOSER_CONFIRMATION_CONFIRM" "GtkFileChooserConfirmation")
;;; 3.98.0 (CINT "GTK_FILE_CHOOSER_CONFIRMATION_ACCEPT_FILENAME" "GtkFileChooserConfirmation")
;;; 3.98.0 (CINT "GTK_FILE_CHOOSER_CONFIRMATION_SELECT_AGAIN" "GtkFileChooserConfirmation")
...
;;; 3.98 ;;; (CINT "GTK_FILE_CHOOSER_PROP_LOCAL_ONLY" "GtkFileChooserProp")
;;; 3.98 ;;; (CINT "GTK_FILE_CHOOSER_PROP_PREVIEW_WIDGET" "GtkFileChooserProp")
;;; 3.98 ;;; (CINT "GTK_FILE_CHOOSER_PROP_PREVIEW_WIDGET_ACTIVE" "GtkFileChooserProp")
;;; 3.98 ;;; (CINT "GTK_FILE_CHOOSER_PROP_EXTRA_WIDGET" "GtkFileChooserProp")
...
;;; 3.98.4 (CFNC "gboolean gdk_display_supports_shapes GdkDisplay* display")
...
;;; 3.98 (CFNC "void gtk_drag_dest_set_track_motion GtkWidget* widget gboolean track_motion")
;;; 3.98 (CFNC "gboolean gtk_drag_dest_get_track_motion GtkWidget* widget")
...
;;; 3.98 (CFNC "GtkTreeViewSearchPositionFunc gtk_tree_view_get_search_position_func GtkTreeView* tree_view")
;;; 3.98 (CFNC "void gtk_tree_view_set_search_position_func GtkTreeView* tree_view GtkTreeViewSearchPositionFunc func lambda_data @func_info GDestroyNotify destroy")
...
;;; 3.98.0 (CINT "GTK_DRAG_RESULT_SUCCESS" "GtkDragResult")
;;; 3.98.0 (CINT "GTK_DRAG_RESULT_NO_TARGET" "GtkDragResult")
;;; 3.98.0 (CINT "GTK_DRAG_RESULT_USER_CANCELLED" "GtkDragResult")
;;; 3.98.0 (CINT "GTK_DRAG_RESULT_TIMEOUT_EXPIRED" "GtkDragResult")
;;; 3.98.0 (CINT "GTK_DRAG_RESULT_GRAB_BROKEN" "GtkDragResult")
;;; 3.98.0 (CINT "GTK_DRAG_RESULT_ERROR" "GtkDragResult")
...
;;; 3.98.2 (CFNC "void gtk_binding_entry_skip GtkBindingSet* binding_set guint keyval GdkModifierType modifiers")
...
;;; 3.98 (CFNC "GList* gtk_icon_theme_list_contexts GtkIconTheme* icon_theme")
...
;;; 3.98.1 (CFNC "void gtk_menu_tool_button_set_arrow_tooltip_text GtkMenuToolButton* button gchar* text" 'const)
;;; 3.98.1 (CFNC "void gtk_menu_tool_button_set_arrow_tooltip_markup GtkMenuToolButton* button gchar* markup" 'const)
;;; 3.98 (CFNC "void gtk_tool_item_set_tooltip_text GtkToolItem* tool_item gchar* text" 'const)
;;; 3.98 (CFNC "void gtk_tool_item_set_tooltip_markup GtkToolItem* tool_item gchar* markup" 'const)
...
;;; 3.98.4? (CINT "GTK_CALENDAR_SHOW_DETAILS" "GtkCalendarDisplayOptions")
;;; 3.98.4? (CFNC "void gtk_calendar_set_detail_func GtkCalendar* calendar GtkCalendarDetailFunc func lambda_data @func_info GDestroyNotify destroy")
;;; 3.98.4? (CFNC "void gtk_calendar_set_detail_width_chars GtkCalendar* calendar gint chars")
;;; 3.98.4? (CFNC "void gtk_calendar_set_detail_height_rows GtkCalendar* calendar gint rows")
;;; 3.98.4? (CFNC "gint gtk_calendar_get_detail_width_chars GtkCalendar* calendar")
;;; 3.98.4? (CFNC "gint gtk_calendar_get_detail_height_rows GtkCalendar* calendar")
...
;;; 3.98.2 (CFNC "gboolean gtk_accel_group_get_is_locked GtkAccelGroup* accel_group")
...
;;; 3.98 (CFNC "GdkAtom gtk_selection_data_get_target GtkSelectionData* selection_data")
;;; 3.98 (CFNC "GdkAtom gtk_selection_data_get_data_type GtkSelectionData* selection_data")
;;; 3.98 (CFNC "gint gtk_selection_data_get_format GtkSelectionData* selection_data")
;;; 3.98 ;;; changed 2.14.1 (CFNC "guchar* gtk_selection_data_get_data GtkSelectionData* selection_data guint* length" 'const)
;;; 3.98 (CFNC "GdkDisplay* gtk_selection_data_get_display GtkSelectionData* selection_data")
...
;;; 3.98.2 (CFNC "GdkModifierType gtk_accel_group_get_modifier_mask GtkAccelGroup* accel_group")
...
;;; 3.98.3 (CFNC "gboolean gdk_keymap_get_caps_lock_state GdkKeymap* keymap")
...
;;; 3.98.1 (CFNC "void gtk_menu_item_set_label GtkMenuItem* menu_item gchar* label")
;;; 3.98.1 (CFNC "gchar* gtk_menu_item_get_label GtkMenuItem* menu_item" 'const)
;;; 3.98.1 (CFNC "void gtk_menu_item_set_use_underline GtkMenuItem* menu_item gboolean setting")
;;; 3.98.1 (CFNC "gboolean gtk_menu_item_get_use_underline GtkMenuItem* menu_item")
...
;;; 3.98.4? (CFNC "void gtk_label_set_track_visited_links GtkLabel* label gboolean track_links")
;;; 3.98.4? (CFNC "gboolean gtk_label_get_track_visited_links GtkLabel* label")
...
;;; 3.98.4 (CFNC "gboolean gtk_widget_has_grab GtkWidget* widget")
...
;;; 3.98 (CFNC "GtkWidget* gtk_statusbar_get_message_area GtkStatusbar* statusbar")
;;; 3.98 (CFNC "PangoEllipsizeMode gtk_tool_item_get_ellipsize_mode GtkToolItem* tool_item")
;;; 3.98 (CFNC "gfloat gtk_tool_item_get_text_alignment GtkToolItem* tool_item")
;;; 3.98 (CFNC "GtkOrientation gtk_tool_item_get_text_orientation GtkToolItem* tool_item")
;;; 3.98 (CFNC "GtkSizeGroup* gtk_tool_item_get_text_size_group GtkToolItem* tool_item")
...
;;; 2.19.6
;;; 3.98.4? (CFNC-3.0 "void gdk_keymap_add_virtual_modifiers GdkKeymap* keymap GdkModifierType* state")
...
;;; 3.98.4? (CFNC-3.0 "void gdk_event_set_device GdkEvent* event GdkDevice* device")
...
;;; 3.98.3 (CFNC-3.0 "GdkDevice* gtk_get_current_event_device void")
...
;;; 2.90.3
;;; 3.98.4? (CFNC-3.0 "void gtk_calendar_select_month GtkCalendar* calendar guint month guint year")
...
;;; 3.98 (CFNC-3.0 "gint gtk_selection_data_get_length GtkSelectionData* selection_data")
...
;;; 3.98.3 (CFNC-3.0 "gboolean gdk_keymap_get_num_lock_state GdkKeymap* keymap")
...
;;; 3.98.2 (CFNC-3.0 "gboolean gtk_binding_set_activate GtkBindingSet* binding_set guint keyval GdkModifierType modifiers GObject* object")
;;; 3.98.2 (CFNC-3.0 "gboolean gtk_bindings_activate GObject* object guint keyval GdkModifierType modifiers")
...
;;; 3.98.0 (CFNC-3.0 "gboolean gdk_cairo_get_clip_rectangle cairo_t* cr GdkRectangle* rect")
...
;;; 3.98 (CFNC-3.0 "void gtk_toolbar_set_drop_highlight_item GtkToolbar* toolbar GtkToolItem* tool_item gint index")
;;; 3.98 (CFNC-3.0 "void gtk_tool_item_toolbar_reconfigured GtkToolItem* tool_item")
...
;;; 3.98.3 (CFNC-3.0 "void gtk_container_set_focus_vadjustment GtkContainer* container GtkAdjustment* adjustment")
;;; 3.98.3 (CFNC-3.0 "GtkAdjustment* gtk_container_get_focus_vadjustment GtkContainer* container")
;;; 3.93.3 (CFNC-3.0 "void gtk_container_set_focus_hadjustment GtkContainer* container GtkAdjustment* adjustment")
;;; 3.98.3 (CFNC-3.0 "GtkAdjustment* gtk_container_get_focus_hadjustment GtkContainer* container")
...
;;; 3.98 (CFNC-3.0 "GtkWindowType gtk_window_get_window_type GtkWindow* window")
...
;;; 3.98 (CFNC-3.0 "GtkWidget* gtk_window_group_get_current_device_grab GtkWindowGroup* window_group GdkDevice* device")
;;;;(CFNC "GType gtk_window_group_get_type void")
;;; 3.98 (CFNC-3.0 "GtkWidget* gtk_window_group_get_current_grab GtkWindowGroup* window_group")
...
;;; 3.98 (CFNC-3.0 "guchar* gtk_selection_data_get_data GtkSelectionData* selection_data" 'const)
...
;;; 3.98 (CCAST-3.0 "GTK_TOOL_SHELL" "GtkToolShell*")
;;; 3.98 (CCHK-3.0 "GTK_IS_TOOL_SHELL" "GtkToolShell*")
;;; 3.98 (CFNC-3.0 "GtkOrientation gtk_tool_shell_get_text_orientation GtkToolShell* shell")
;;; 3.98 (CFNC-3.0 "gfloat gtk_tool_shell_get_text_alignment GtkToolShell* shell")
;;; 3.98 (CFNC-3.0 "PangoEllipsizeMode gtk_tool_shell_get_ellipsize_mode GtkToolShell* shell")
;;; 3.98 (CFNC-3.0 "GtkSizeGroup* gtk_tool_shell_get_text_size_group GtkToolShell* shell")
;;; (CFNC-3.0 "GtkIconSize gtk_tool_shell_get_icon_size GtkToolShell* shell")
;;; 3.98 (CFNC-3.0 "GtkOrientation gtk_tool_shell_get_orientation GtkToolShell* shell")
;;; 3.98 (CFNC-3.0 "GtkToolbarStyle gtk_tool_shell_get_style GtkToolShell* shell")
;;; 3.89 (CFNC-3.0 "GtkReliefStyle gtk_tool_shell_get_relief_style GtkToolShell* shell")
;;; 3.98 (CFNC-3.0 "void gtk_tool_shell_rebuild_menu GtkToolShell* shell")
...
;;; 3.98.2 (CFNC-3.0 "void gtk_accel_map_lock_path gchar* accel_path" 'const)
;;; 3.98.2 (CFNC-3.0 "void gtk_accel_map_unlock_path gchar* accel_path" 'const)
...
;;; 3.98 (CINT-3.0 "GTK_ICON_LOOKUP_FORCE_SIZE" "GtkIconLookupFlags")
;;; 3.98 (CINT-3.0 "GTK_ICON_THEME_NOT_FOUND" "GtkIconThemeError")
;;; 3.98 (CINT-3.0 "GTK_ICON_THEME_FAILED" "GtkIconThemeError")
;;; 3.98 ;gtkicontheme: gtk_icon_theme_choose_icon -- ref array?
;;; 3.98 ;gtkicontheme: gtk_icon_info_load_symbolic
;;; 3.98 ;gtkicontheme: gtk_icon_info_load_symbolic_for_context
;;; 3.98 (CFNC-3.0 "GtkIconInfo* gtk_icon_theme_lookup_by_gicon GtkIconTheme* icon_theme GIcon* icon gint size GtkIconLookupFlags flags")
;;; 3.98 (CFNC-3.0 "GtkIconInfo* gtk_icon_info_new_for_pixbuf GtkIconTheme* icon_theme GdkPixbuf* pixbuf")
...
;;; 3.98.4? (CFNC-3.0 "gboolean gtk_text_view_im_context_filter_keypress GtkTextView* text_view GdkEventKey* event")
...
;;; 3.98.1 (CFNC-3.0 "void gtk_menu_item_set_reserve_indicator GtkMenuItem* menu_item gboolean reserve")
;;; 3.98.1 (CFNC-3.0 "gboolean gtk_menu_item_get_reserve_indicator GtkMenuItem* menu_item")
;;; 3.98.1 (CFNC-3.0 "GtkWidget* gtk_menu_shell_get_selected_item GtkMenuShell* menu_shell")
;;; 3.98.1 (CFNC-3.0 "GtkWidget* gtk_menu_shell_get_parent_shell GtkMenuShell* menu_shell")
;;; 3.98 (CFNC-3.0 "guchar* gtk_selection_data_get_data_with_length GtkSelectionData* selection_data gint* [length]" 'const)
...
;;; 3.98.4 (CFNC-3.0 "void gtk_window_set_has_user_ref_count GtkWindow* window gboolean setting")
...
;;; 3.98 (CFNC-3.2 "char* gtk_widget_path_to_string GtkWidgetPath* path" 'const)
...
;;; 3.98.1 (CFNC-3.2 "void gtk_drag_source_set_icon_gicon GtkWidget* widget GIcon* icon")
...
;;; 3.98.4? (CFNC-3.2 "gboolean gdk_event_get_button GdkEvent* event guint* button")
;;; 3.98.4? (CFNC-3.2 "gboolean gdk_event_get_click_count GdkEvent* event guint* click_count")
;;; 3.98.4? (CFNC-3.2 "gboolean gdk_event_get_keyval GdkEvent* event guint* keyval")
;;; 3.98.4? (CFNC-3.2 "gboolean gdk_event_get_keycode GdkEvent* event guint16* keycode")
;;; 3.98.4? (CFNC-3.2 "gboolean gdk_event_get_scroll_direction GdkEvent* event GdkScrollDirection* [direction]")
...
;;; 3.98.3 (CINT-3.4 "GDK_MODIFIER_INTENT_PRIMARY_ACCELERATOR" "GdkModifierIntent")
;;; 3.98.3 (CINT-3.4 "GDK_MODIFIER_INTENT_CONTEXT_MENU" "GdkModifierIntent")
;;; 3.98.3 (CINT-3.4 "GDK_MODIFIER_INTENT_EXTEND_SELECTION" "GdkModifierIntent")
;;; 3.98.3 (CINT-3.4 "GDK_MODIFIER_INTENT_MODIFY_SELECTION" "GdkModifierIntent")
;;; 3.98.3 (CINT-3.4 "GDK_MODIFIER_INTENT_NO_TEXT_INPUT" "GdkModifierIntent")
;;; 3.98.3 (CINT-3.4 "GDK_MODIFIER_INTENT_SHIFT_GROUP" "GdkModifierIntent")
...
;;; 3.98.3 (CFNC-3.4 "GdkModifierType gdk_keymap_get_modifier_mask GdkKeymap* keymap GdkModifierIntent intent")
;;; 3.98.4? (CFNC-3.4 "void gtk_accelerator_parse_with_keycode gchar* accelerator guint* accelerator_key guint** accelerator_codes GdkModifierType* accelerator_mods" 'const)
...
;;; 3.98 (CFNC-3.4 "void gtk_window_set_attached_to GtkWindow* window GtkWidget* attach_widget")
;;; 3.98 (CFNC-3.4 "GtkWidget* gtk_window_get_attached_to GtkWindow* window")
...
;;; 3.98.3 (CFNC-3.4 "guint gdk_keymap_get_modifier_state GdkKeymap* keymap")
;;; 3.98.4? (CFNC-3.4 "void gtk_hsv_to_rgb gdouble h gdouble s gdouble v gdouble* [r] gdouble* [g] gdouble* [b]")
;;; 3.98.4? (CFNC-3.4 "void gtk_rgb_to_hsv gdouble r gdouble g gdouble b gdouble* [h] gdouble* [s] gdouble* [v]")
...
;;; 3.98.4? (CFNC-3.6 "GtkMenu* gtk_menu_button_get_popup GtkMenuButton* menu_button")
...
;;; 3.98.1 (CFNC-3.6 "void gtk_menu_shell_bind_model GtkMenuShell* menu_shell GMenuModel* model gchar* action_namespace gboolean with_separators" 'const)
...
;;; 3.98.4 (CFNC-3.10 "void gtk_header_bar_set_title GtkHeaderBar* bar gchar* title" 'const)
;;; 3.98.4 (CFNC-3.10 "gchar* gtk_header_bar_get_title GtkHeaderBar* bar" 'const)
;;; 3.98.4 (CFNC-3.10 "void gtk_header_bar_set_subtitle GtkHeaderBar* bar gchar* subtitle" 'const)
;;; 3.98.4 (CFNC-3.10 "gchar* gtk_header_bar_get_subtitle GtkHeaderBar* bar" 'const)
;;; 3.98.4 (CFNC-3.10 "void gtk_header_bar_set_custom_title GtkHeaderBar* bar GtkWidget* title_widget")
;;; 3.98.4 (CFNC-3.10 "GtkWidget* gtk_header_bar_get_custom_title GtkHeaderBar* bar")
...
;;; 3.98 (CFNC-3.10 "GtkIconInfo* gtk_icon_theme_lookup_icon_for_scale GtkIconTheme* icon_theme gchar* icon_name gint size gint scale GtkIconLookupFlags flags" 'const)
;;; 3.98 ;(CFNC-3.10 "GtkIconInfo* gtk_icon_theme_choose_icon_for_scale GtkIconTheme* icon_theme gchar* icon_names[] gint size gint scale GtkIconLookupFlags flags" 'const)
;;; 3.98 (CFNC-3.10 "GdkPixbuf* gtk_icon_theme_load_icon_for_scale GtkIconTheme* icon_theme gchar* icon_name gint size gint scale GtkIconLookupFlags flags GError** [error]" 'const)
;;; 3.98 (CFNC-3.10 "GtkIconInfo* gtk_icon_theme_lookup_by_gicon_for_scale GtkIconTheme* icon_theme GIcon* icon gint size gint scale GtkIconLookupFlags flags")
;;; 3.98 (CFNC-3.10 "gint gtk_icon_info_get_base_scale GtkIconInfo* icon_info")
...
;;; 3.98.4 (CFNC-3.12 "void gtk_header_bar_set_has_subtitle GtkHeaderBar* bar gboolean setting")
;;; 3.98.4 (CFNC-3.12 "gboolean gtk_header_bar_get_has_subtitle GtkHeaderBar* bar")
...
;;; 3.98.4? (CFNC-3.12 "gboolean gtk_icon_info_is_symbolic GtkIconInfo* icon_info")
...
;;; 3.98.1 (CCAST-3.14 "GTK_GESTURE_MULTI_PRESS" "GtkGestureMultiPress*")
;;; 3.98.1 (CCHK-3.14 "GTK_IS_GESTURE_MULTI_PRESS" "GtkGestureMultiPress*")
...
;;; 3.98.1 (CFNC-3.14 "void gtk_gesture_multi_press_set_area GtkGestureMultiPress* gesture GdkRectangle* rect")
;;; 3.98.1 (CFNC-3.14 "gboolean gtk_gesture_multi_press_get_area GtkGestureMultiPress* gesture GdkRectangle* rect")
...
;;; 3.13.4:
;;; 3.98 (CFNC-3.14 "void gtk_icon_theme_add_resource_path GtkIconTheme* icon_theme gchar* path" 'const)
...
;;; 3.98 (CFNC-3.14 "GtkStateFlags gtk_widget_path_iter_get_state GtkWidgetPath* path gint pos" 'const)
;;; 3.98 (CFNC-3.14 "void gtk_widget_path_iter_set_state GtkWidgetPath* path gint pos GtkStateFlags state")
...
;;; 3.98.3 (CFNC-3.18 "gboolean gdk_keymap_get_scroll_lock_state GdkKeymap* keymap")
;;; 3.98 (CFNC-3.18 "void gtk_radio_menu_item_join_group GtkRadioMenuItem* radio_menu_item GtkRadioMenuItem* group_source")
...
;;; 3.98.3 (CINT-3.18 "GDK_MODIFIER_INTENT_DEFAULT_MOD_MASK" "GdkModifierIntent")
...
;;; 3.98 (CFNC-3.20 "char* gtk_widget_path_iter_get_object_name GtkWidgetPath* path gint pos" 'const-return)
;;; 3.98 (CFNC-3.20 "void gtk_widget_path_iter_set_object_name GtkWidgetPath* path gint pos char* name" 'const)
...
;;; 3.98.0 (CFNC-3.20 "void gdk_seat_ungrab GdkSeat* seat")
...
;;; 3.98.4? (CFNC-3.20 "gboolean gdk_event_is_scroll_stop_event GdkEvent* event" 'const)
(CFNC-3.20 "void gtk_text_view_reset_cursor_blink GtkTextView* text_view")

;;; 3.19.8:

;;; 3.98 ;(CFNC-3.20 "void gtk_render_background_get_clip GtkStyleContext* context gdouble x gdouble y gdouble width gdouble height GdkRectangle* [out_clip]")
...
;;; 3.98.4? (CFNC-3.22 "void gdk_event_set_device_tool GdkEvent* event GdkDeviceTool* tool")
...
;;; 3.98.4 (CFNC-3.22 "int gdk_display_get_n_monitors GdkDisplay* display")
;;; 3.98.4? (CFNC-3.22 "GdkMonitor* gdk_display_get_monitor GdkDisplay* display int monitor_num")
...
;;; 3.98.0 (CFNC-3.22 "gboolean gdk_monitor_is_primary GdkMonitor* monitor")
...
;;; 3.98.4? (CFNC-3.22 "void gtk_menu_popup_at_widget GtkMenu* menu GtkWidget* widget GdkGravity widget_anchor GdkGravity menu_anchor GdkEvent* trigger_event")
;;; 3.98.4? (CFNC-3.22 "void gtk_menu_popup_at_pointer GtkMenu* menu GdkEvent* trigger_event")
...
;;; 3.98.3 (CFNC-3.92 "gboolean gtk_show_uri_on_window GtkWindow* parent char* uri guint32 timestamp GError** [error]" 'const)
...
;;; 3.98.4? (CFNC-3.92 "void gdk_event_set_coords GdkEvent* event gdouble x gdouble y")
...
;;; 3.98 (CSTR-3.92 "GTK_STYLE_CLASS_TOOLBAR")
;;; 3.98 (CSTR-3.92 "GTK_STYLE_CLASS_PRIMARY_TOOLBAR")
;;; 3.98 (CSTR-3.92 "GTK_STYLE_CLASS_INLINE_TOOLBAR")
...
;;; 3.98.4? (CFNC-3.92 "GtkStyleContext* gtk_style_context_new void")
...
;;; 3.98.4? (CFNC-3.92 "GtkCssSection* gtk_style_context_get_section GtkStyleContext* context gchar* property" 'const)
;;; 3.98.4? (CFNC-3.92 "void gtk_style_context_get_property GtkStyleContext* context gchar* property GValue* value")
...
;;; 3.98.4? (CFNC-3.92 "void gtk_style_context_set_path GtkStyleContext* context GtkWidgetPath* path")
;;; 3.98.4? (CFNC-3.92 "GtkWidgetPath* gtk_style_context_get_path GtkStyleContext* context" 'const-return)
;;; 3.98.4? (CFNC-3.92 "void gtk_style_context_set_parent GtkStyleContext* context GtkStyleContext* parent")
;;; 3.98.4? (CFNC-3.92 "GtkStyleContext* gtk_style_context_get_parent GtkStyleContext* context")
;;; 3.98.4 (CFNC-3.92 "GList* gtk_style_context_list_classes GtkStyleContext* context")
...
;;; 3.98.1 (CFNC-3.94 "GtkGesture* gtk_gesture_multi_press_new void")
...
;(CCHK-3.94 "GTK_IS_EMOJI_CHOOSER(obj)" "GtkEmojiChooser*")
;(CCAST-3.94 "GTK_EMOJI_CHOOSER(obj)" "GtkEmojiChooser*")
...
;;; 3.98.4? (CFNC-3.94 "void gdk_event_set_keyval GdkEvent* event guint keyval")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_key_is_modifier GdkEvent* event gboolean* [is_modifier]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_key_group GdkEvent* event guint* [group]")
...
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_is_sent GdkEvent* event")
;;; 3.96.0 (CFNC-3.94 "gboolean gdk_event_get_drag_context GdkEvent* event GdkDrag** [context]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_crossing_mode GdkEvent* event GdkCrossingMode* [mode]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_crossing_detail GdkEvent* event GdkNotifyType* [detail]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_touchpad_gesture_phase GdkEvent* event GdkTouchpadGesturePhase* [phase]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_touchpad_gesture_n_fingers GdkEvent* event guint* [n_fingers]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_touchpad_deltas GdkEvent* event double* [dx] double* [dy]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_touchpad_angle_delta GdkEvent* event double* [delta]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_touchpad_scale GdkEvent* event double* [scale]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_touch_emulating_pointer GdkEvent* event gboolean* [emulating]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_focus_in GdkEvent* event gboolean* [focus_in]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_pad_group_mode GdkEvent* event guint* [group] guint* [mode]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_pad_button GdkEvent* event guint* [button]")
;;; 3.98.4? (CFNC-3.94 "gboolean gdk_event_get_pad_axis_value GdkEvent* event guint* [index] gdouble* [value]")
...
(CFNC-3.94 "GtkWidget* gtk_emoji_chooser_new void")
...
;;; 3.98.4? (CCAST-3.94 "GDK_EVENT" "GdkEvent*")
...
(CFNC-3.94 "GType* gdk_content_formats_get_gtypes GdkContentFormats* formats gsize* [n_gtypes]" 'const-return) ; now also const formats (3.98)
(CFNC-3.94 "char** gdk_content_formats_get_mime_types GdkContentFormats* formats gsize* [n_mime_types]" 'const-return) ; now also const formats (3.98)
...
;;; 3-98.3 (CFNC-3.94 "GdkKeymap* gdk_display_get_keymap GdkDisplay* display")
...
;;; 3.98 (CFNC-3.94 "GtkIconTheme* gtk_icon_theme_get_for_display GdkDisplay* display")
;;; 3.98 (CFNC-3.94 "void gtk_icon_theme_set_display GtkIconTheme* icon_theme GdkDisplay* display")
;;; 3.98.4? (CFNC-3.94 "GdkTexture* gtk_icon_info_load_texture GtkIconInfo* icon_info")
...
;;; 3.98 (CFNC-3.94 "GdkContentFormats* gtk_content_formats_add_text_targets GdkContentFormats* list")
;;; 3.98 (CFNC-3.94 "GdkContentFormats* gtk_content_formats_add_image_targets GdkContentFormats* list gboolean writable")
;;; 3.98 (CFNC-3.94 "GdkContentFormats* gtk_content_formats_add_uri_targets GdkContentFormats* list")
...
;;; 3.98 (CFNC-3.94 "void gtk_selection_data_set GtkSelectionData* selection_data GdkAtom type gint format guchar* data gint length")
;;; 3.98 (CFNC-3.94 "gboolean gtk_selection_data_set_text GtkSelectionData* selection_data gchar* str gint len" 'const)
;;; 3.98 (CFNC-3.94 "guchar* gtk_selection_data_get_text GtkSelectionData* selection_data")
;;; 3.98 (CFNC-3.94 "gboolean gtk_selection_data_set_pixbuf GtkSelectionData* selection_data GdkPixbuf* pixbuf")
...
;;; 3.98 (CFNC-3.94 "GdkPixbuf* gtk_selection_data_get_pixbuf GtkSelectionData* selection_data")
;;; 3.98 (CFNC-3.94 "gboolean gtk_selection_data_set_texture GtkSelectionData* selection_data GdkTexture* texture")
;;; 3.98 (CFNC-3.94 "GdkTexture* gtk_selection_data_get_texture GtkSelectionData* selection_data")
;;; 3.98 (CFNC-3.94 "gboolean gtk_selection_data_set_uris GtkSelectionData* selection_data gchar** uris")
;;; 3.98 (CFNC-3.94 "gchar** gtk_selection_data_get_uris GtkSelectionData* selection_data")
;;; 3.98 (CFNC-3.94 "gboolean gtk_selection_data_get_targets GtkSelectionData* selection_data GdkAtom** [targets] gint* [natoms]")
;;; 3.98 (CFNC-3.94 "gboolean gtk_selection_data_targets_include_text GtkSelectionData* selection_data")
;;; 3.98 ;;; (CFNC-3.94 "gboolean gtk_selection_data_targets_include_image GtkSelectionData* selection_data gboolean writable")
;;; 3.98 (CFNC-3.94 "gboolean gtk_selection_data_targets_include_uri GtkSelectionData* selection_data")
;;; 3.98 (CFNC-3.94 "gboolean gtk_targets_include_text GdkAtom* targets gint n_targets")
;;; 3.98 (CFNC-3.94 "gboolean gtk_targets_include_image GdkAtom* targets gint n_targets gboolean writable")
;;; 3.98 (CFNC-3.94 "gboolean gtk_targets_include_uri GdkAtom* targets gint n_targets")
...
;;; 3.98.3 (CFNC-3.94 "void gtk_style_context_reset_widgets GdkDisplay* display")
...
;;; 3.98 (CFNC-3.94 "void gtk_tree_view_enable_model_drag_dest GtkTreeView* tree_view GdkContentFormats* formats GdkDragAction actions")
...
;;; 3.98 (CFNC-3.94 "GdkTexture* gtk_text_iter_get_texture GtkTextIter* iter")
...
;;; 3.98 (CFNC-3.94 "void gtk_icon_view_enable_model_drag_dest GtkIconView* icon_view GdkContentFormats* targets GdkDragAction actions")
...
;;; 3.98 (CFNC-3.94 "void gtk_drag_dest_set GtkWidget* widget GtkDestDefaults flags GdkContentFormats* targets GdkDragAction actions")
;;; 3.98 (CFNC-3.94 "GdkContentFormats* gtk_drag_dest_get_target_list GtkWidget* widget")
;;; 3.98 (CFNC-3.94 "void gtk_drag_dest_set_target_list GtkWidget* widget GdkContentFormats* @target_list")
;;; 3.98.1 (CFNC-3.94 "GdkContentFormats* gtk_drag_source_get_target_list GtkWidget* widget")
;;; 3.98.1 (CFNC-3.94 "void gtk_drag_source_set_target_list GtkWidget* widget GdkContentFormats* @target_list")
...
;;; 3.98.0 (CINT-3.94 "GDK_MODE_DISABLED" "GdkInputMode")
;;; 3.98.0 (CINT-3.94 "GDK_MODE_SCREEN" "GdkInputMode")
;;; 3.98.0 (CINT-3.94 "GDK_MODE_SURFACE" "GdkInputMode")
...
;;; 3.98 (CINT-3.94 "GDK_SURFACE_TOPLEVEL" "GdkSurfaceType")
;;; 3.98 (CINT-3.94 "GDK_SURFACE_CHILD" "GdkSurfaceType")
;;; 3.98 (CINT-3.94 "GDK_SURFACE_TEMP" "GdkSurfaceType")
;;; 3.96 (CINT-3.94 "GDK_SURFACE_SUBSURFACE" "GdkSurfaceType")

;;; 3.98.3 (CINT-3.94 "GDK_HINT_POS" "GdkSurfaceHints")
;;; 3.98.3 (CINT-3.94 "GDK_HINT_MIN_SIZE" "GdkSurfaceHints")
;;; 3.98.3 (CINT-3.94 "GDK_HINT_MAX_SIZE" "GdkSurfaceHints")
;;; 3.98.3 (CINT-3.94 "GDK_HINT_BASE_SIZE" "GdkSurfaceHints")
;;; 3.98.3 (CINT-3.94 "GDK_HINT_ASPECT" "GdkSurfaceHints")
;;; 3.98.3 (CINT-3.94 "GDK_HINT_RESIZE_INC" "GdkSurfaceHints")
;;; 3.98.3 (CINT-3.94 "GDK_HINT_WIN_GRAVITY" "GdkSurfaceHints")
;;; 3.98.3 (CINT-3.94 "GDK_HINT_USER_POS" "GdkSurfaceHints")
;;; 3.98.3 (CINT-3.94 "GDK_HINT_USER_SIZE" "GdkSurfaceHints")
...
;;; 3.98 (CINT-3.94 "GDK_SURFACE_TYPE_HINT_TOOLBAR" "GdkSurfaceTypeHint")
...
;;; 3.98.4? (CFNC-3.94 "void gtk_menu_popup_at_rect GtkMenu* menu GdkSurface* rect_window GdkRectangle* rect GdkGravity rect_anchor GdkGravity menu_anchor GdkEvent* trigger_event")
...
;;; 3.98 (CFNC-3.94 "void gtk_window_begin_resize_drag GtkWindow* window GdkSurfaceEdge edge gint button gint x gint y guint32 timestamp")
;;; 3.98 (CFNC-3.94 "void gtk_window_set_type_hint GtkWindow* window GdkSurfaceTypeHint hint")
...
;;; 3.98 (CINT-3.94 "GDK_SURFACE_STATE_ICONIFIED" "GdkSurfaceState")
...
;;; 3.98.1 (CFNC-3.94 "void gdk_drop_status GdkDrop* self GdkDragAction actions")
...
;;; 3.98.0 (CFNC-3.94 "void gdk_drop_read_text_async GdkDrop* drop GCancellable* cancellable GAsyncReadyCallback callback gpointer user_data")
;;; 3.98.0 (CFNC-3.94 "char* gdk_drop_read_text_finish GdkDrop* drop GAsyncResult* result GError** [error]")
...
(CFNC-3.94 "GtkWidget* gtk_event_controller_get_widget GtkEventController* controller")
;;; 3.98.0 (CFNC-3.94 "gboolean gtk_event_controller_handle_event GtkEventController* controller GdkEvent* event")
(CFNC-3.94 "void gtk_event_controller_reset GtkEventController* controller")
(CFNC-3.94 "GtkPropagationPhase gtk_event_controller_get_propagation_phase GtkEventController* controller")
(CFNC-3.94 "void gtk_event_controller_set_propagation_phase GtkEventController* controller GtkPropagationPhase phase")
...
;;; 3.98 (CFNC-3.96 "GtkWidget* gtk_drag_get_source_widget GdkDrag* context")
...
;;; 3.98.4? (CFNC-3.96 "GtkWidget* gtk_menu_bar_new_from_model GMenuModel* model")
...
;;; 3.98 (CFNC-3.96 "GtkWidget* gtk_root_get_for_surface GdkSurface* surface")
...
;;; 3.98 (CFNC-3.96 "void gtk_drag_get_data GtkWidget* widget GdkDrop* drop GdkAtom target")
;;; 3.98 (CFNC-3.96 "void gtk_drag_set_icon_widget GdkDrag* context GtkWidget* widget gint hot_x gint hot_y")
;;; 3.98 (CFNC-3.96 "void gtk_drag_set_icon_default GdkDrag* context")
;;; 3.98 (CFNC-3.96 "void gtk_drag_set_icon_name GdkDrag* context gchar* icon_name gint hot_x gint hot_y" 'const)
;;; 3.96.0 (CFNC-3.96 "void gtk_drag_set_icon_surface GdkDrag* context cairo_surface_t* surface")
;;; 3.98 (CFNC-3.96 "void gtk_drag_set_icon_gicon GdkDrag* context GIcon* icon gint hot_x gint hot_y")
;;; 3.98 (CFNC-3.96 "void gtk_drag_cancel GdkDrag* context")
...
(CFNC-3.98 "GtkWidget* gtk_window_new void")
;;; 3.98.4? (CFNC-3.98 "gboolean gtk_window_activate_key GtkWindow* window GdkEvent* event")
;;; 3.98.4? (CFNC-3.98 "gboolean gtk_window_propagate_key_event GtkWindow* window GdkEvent* event")
...
;;; 3.98.4? (CFNC-3.98 "gboolean gtk_event_controller_handle_event GtkEventController* controller GdkEvent* event")
...
(CFNC-3.98 "void gtk_scale_set_format_value_func GtkScale* scale GtkScaleFormatValueFunc func gpointer func_info GDestroyNotify destroy_notify")
...
;;; 3.98.4? (CFNC-3.98 "GClosure* gtk_accel_label_get_accel_closure GtkAccelLabel* accel_label")
...
;;; 3.98.4 (CFNC-3.98 "void gtk_gesture_click_set_area GtkGestureClick* gesture GdkRectangle* rect" 'const)
;;; 3.98.4 (CFNC-3.98 "gboolean gtk_gesture_click_get_area GtkGestureClick* gesture GdkRectangle* rect")
...
;;; 3.98.4? (CFNC-3.98 "gboolean gdk_surface_is_viewable GdkSurface* surface")
...
;;; 3.98.4 (CFNC-3.98 "void gdk_surface_begin_resize_drag GdkSurface* surface GdkSurfaceEdge edge GdkDevice* device gint button gint x gint y guint32 timestamp")
;;; 3.98.4 (CFNC-3.98 "void gdk_surface_begin_move_drag GdkSurface* surface GdkDevice* device gint button gint x gint y guint32 timestamp")
...
;;; 3.98.3 (CFNC-3.98 "void gdk_surface_constrain_size GdkGeometry* geometry GdkSurfaceHints flags gint width gint height gint* new_width gint* new_height")
...
;;; ridiculous type (CFNC-3.98 "void gtk_icon_theme_set_search_path GtkIconTheme* self char* path" 'const)
...
;;; same as above (CFNC-3.98 "void gtk_icon_theme_set_resource_path GtkIconTheme* self char* path" 'const)
...
;;; 3.98.4? (CFNC-3.98 "GtkIconPaintable* gtk_icon_theme_lookup_icon GtkIconTheme* self char* icon_name char* fallbacks gint size gint scale GtkTextDirection direction GtkIconLookupFlags flags")
...
;;; 3.98.4? (CFNC-3.98 "GList* gtk_constraint_layout_add_constraints_from_description GtkConstraintLayout* layout char* lines gsize n_lines int hspacing int vspacing GError** error char* first_view ...")
;;; 3.98.4? (CFNC-3.98 "GList* gtk_constraint_layout_add_constraints_from_descriptionv GtkConstraintLayout* layout char* lines gsize n_lines int hspacing int vspacing GHashTable* views GError** error")
...
(CFNC-3.98 "void gtk_menu_button_set_label GtkMenuButton* menu_button char* label" 'const)
(CFNC-3.98 "char* gtk_menu_button_get_label GtkMenuButton* menu_button" 'const-return)
;;; 3.98.3 (CFNC-3.98 "void gtk_menu_button_set_relief GtkMenuButton* menu_button GtkReliefStyle relief")
;;; 3.98.3 (CFNC-3.98 "GtkReliefStyle gtk_menu_button_get_relief GtkMenuButton* menu_button")
...
(CFNC-3.98 "void gtk_menu_button_set_create_popup_func GtkMenuButton* menu_button GtkMenuButtonCreatePopupFunc func gpointer func_info GDestroyNotify destroy_notify")
...
;;; 3.98.4? (CFNC-3.98 "void gtk_style_context_get_valist GtkStyleContext* context char* first_property_name va_list args" 'const)
;;; 3.98.4? (CFNC-3.98 "void gtk_style_context_get GtkStyleContext* context char* first_property_name ..." 'const)
...
(CFNC-3.98 "GdkContentProvider* gtk_tree_create_row_drag_content GtkTreeModel* tree_model GtkTreePath* path")
(CFNC-3.98 "gboolean gtk_tree_get_row_drag_data GValue* value GtkTreeModel** tree_model GtkTreePath** path")
(CFNC-3.98 "GdkContentProvider* gtk_tree_drag_source_drag_data_get GtkTreeDragSource* drag_source GtkTreePath* path")
...
(CFNC-3.98 "void gtk_text_buffer_set_enable_undo GtkTextBuffer* buffer gboolean enable_undo")
(CFNC-3.98 "guint gtk_text_buffer_get_max_undo_levels GtkTextBuffer* buffer")
(CFNC-3.98 "void gtk_text_buffer_set_max_undo_levels GtkTextBuffer* buffer guint max_undo_levels")
...
;;; type (CFNC-3.98 "void gtk_file_chooser_add_choice GtkFileChooser* chooser char* id char* label char** options char** option_labels")
(CFNC-3.98 "void gtk_file_chooser_remove_choice GtkFileChooser* chooser char* id" 'const)
(CFNC-3.98 "void gtk_file_chooser_set_choice GtkFileChooser* chooser char* id char* option" 'const)
...
;;; type (CFNC-3.98 "gboolean gtk_widget_class_query_action GtkWidgetClass* widget_class guint index_ GType* owner char** action_name GVariantType** parameter_type const char** property_name")
...
;(CFNC-3.98 "void gtk_widget_insert_action_group GtkWidget* widget gchar* name GActionGroup* group" 'const)
;(CFNC-3.98 "gboolean gtk_widget_activate_action GtkWidget* widget char* name char* format_string ..." 'const)
(CFNC-3.98 "gboolean gtk_widget_activate_action_variant GtkWidget* widget char* name GVariant* vargs" 'const)
...
(CCAST-3.98 "GTK_POPOVER_MENU" "GtkPopoverMenu*")
(CCHK-3.98 "GTK_IS_POPOVER_MENU" "GtkPopoverMenu*")
...
(CFNC-3.98 "void g_menu_prepend_item GMenu* menu GMenuItem* item")
(CFNC-3.98 "void g_menu_append_item GMenu* menu GMenuItem* item")
(CFNC-3.98 "void g_menu_remove GMenu* menu gint position")
(CFNC-3.98 "void g_menu_remove_all GMenu* menu")
(CFNC-3.98 "void g_menu_insert GMenu* menu gint position gchar* label gchar* detailed_action")
(CFNC-3.98 "void g_menu_prepend GMenu* menu gchar* label gchar* detailed_action")
(CFNC-3.98 "void g_menu_append GMenu* menu gchar* label gchar* detailed_action")
(CFNC-3.98 "void g_menu_insert_section GMenu* menu gint position gchar* label GMenuModel* section")
(CFNC-3.98 "void g_menu_prepend_section GMenu* menu gchar* label GMenuModel* section")
(CFNC-3.98 "void g_menu_append_section GMenu* menu gchar* label GMenuModel* section")
...
(CFNC-3.98 "GMenuItem* g_menu_item_new_section gchar* label GMenuModel* section")
(CFNC-3.98 "GVariant* g_menu_item_get_attribute_value GMenuItem* menu_item gchar* attribute GVariantType* expected_type")
;(CFNC-3.98 "gboolean g_menu_item_get_attribute GMenuItem* menu_item gchar* attribute gchar* format_string ...")
(CFNC-3.98 "GMenuModel* g_menu_item_get_link GMenuItem* menu_item gchar* link")
(CFNC-3.98 "void g_menu_item_set_attribute_value GMenuItem* menu_item gchar* attribute GVariant* value")
(CFNC-3.98 "void g_menu_item_set_attribute GMenuItem* menu_item gchar* attribute gchar* format_string ")
(CFNC-3.98 "void g_menu_item_set_link GMenuItem* menu_item gchar* link GMenuModel* model")
(CFNC-3.98 "void g_menu_item_set_label GMenuItem* menu_item gchar* label")
(CFNC-3.98 "void g_menu_item_set_submenu GMenuItem* menu_item GMenuModel* submenu")
(CFNC-3.98 "void g_menu_item_set_section GMenuItem* menu_item GMenuModel* section")
(CFNC-3.98 "void g_menu_item_set_action_and_target_value GMenuItem* menu_item gchar* action GVariant* target_value")
(CFNC-3.98 "void g_menu_item_set_action_and_target GMenuItem* menu_item gchar* action gchar* format_string ")
...
(CINT-3.98 "GTK_SHORTCUT_SCOPE_LOCAL" "GtkShortcutScope")
(CINT-3.98 "GTK_SHORTCUT_SCOPE_MANAGED" "GtkShortcutScope")
(CINT-3.98 "GTK_SHORTCUT_SCOPE_GLOBAL" "GtkShortcutScope")
(CINT-3.98 "GTK_SHORTCUT_ACTION_EXCLUSIVE" "GtkShortcutActionFlags")
;;; 3.98.3 (CINT-3.98 "GTK_SHORTCUT_TRIGGER_MATCH_NONE" "GtkShortcutTriggerMatch")
;;; 3.98.3 (CINT-3.98 "GTK_SHORTCUT_TRIGGER_MATCH_PARTIAL" "GtkShortcutTriggerMatch")
;;; 3.98.3 (CINT-3.98 "GTK_SHORTCUT_TRIGGER_MATCH_EXACT" "GtkShortcutTriggerMatch")

(CCAST-3.98 "GTK_SHORTCUT_CONTROLLER" "GtkShortcutController*")
(CCHK-3.98 "GTK_IS_SHORTCUT_CONTROLLER" "GtkShortcutController*")

(CFNC-3.98 "GdkModifierType gtk_accelerator_get_default_mod_mask void")
(CFNC-3.98 "void gdk_toplevel_inhibit_system_shortcuts GdkToplevel* toplevel GdkEvent* event")
(CFNC-3.98 "void gdk_toplevel_restore_system_shortcuts GdkToplevel* toplevel")
(CFNC-3.98 "gboolean gtk_accelerator_valid guint keyval GdkModifierType modifiers" 'const)
(CFNC-3.98 "gboolean gtk_accelerator_parse gchar* accelerator guint* accelerator_key GdkModifierType* accelerator_mods" 'const)
;(CFNC-3.98 "gboolean gtk_accelerator_parse_with_keycode gchar* accelerator GdkDisplay* display guint* accelerator_key guint** [accelerator_codes] GdkModifierType* [accelerator_mods]" 'const)
;(CFNC-3.98 "gchar* gtk_accelerator_name guint accelerator_key GdkModifierType accelerator_mods")
;(CFNC-3.98 "gchar* gtk_accelerator_name_with_keycode GdkDisplay* display guint accelerator_key guint keycode GdkModifierType accelerator_mods")
;(CFNC-3.98 "gchar* gtk_accelerator_get_label guint accelerator_key GdkModifierType accelerator_mods")
;(CFNC-3.98 "gchar* gtk_accelerator_get_label_with_keycode GdkDisplay* display guint accelerator_key guint keycode GdkModifierType accelerator_mods")
;;; 3.98.4? (CFNC-3.98 "void gtk_accelerator_set_default_mod_mask GdkModifierType default_mod_mask")
(CFNC-3.98 "GListModel* gtk_flatten_list_model_get_model_for_item GtkFlattenListModel* self guint position")
(CFNC-3.98 "void gtk_menu_button_set_use_underline GtkMenuButton* menu_button gboolean use_underline")
(CFNC-3.98 "gboolean gtk_menu_button_get_use_underline GtkMenuButton* menu_button")
(CFNC-3.98 "void gtk_popover_set_mnemonics_visible GtkPopover* popover gboolean mnemonics_visible")
(CFNC-3.98 "gboolean gtk_popover_get_mnemonics_visible GtkPopover* popover")
(CFNC-3.98 "GtkShortcut* gtk_shortcut_new GtkShortcutTrigger* trigger GtkShortcutAction* action")
;(CFNC-3.98 "GtkShortcut* gtk_shortcut_new_with_arguments GtkShortcutTrigger* trigger GtkShortcutAction* action gchar* format_string ..." 'const)
(CFNC-3.98 "GtkShortcutTrigger* gtk_shortcut_get_trigger GtkShortcut* self")
(CFNC-3.98 "void gtk_shortcut_set_trigger GtkShortcut* self GtkShortcutTrigger* trigger")
(CFNC-3.98 "GtkShortcutAction* gtk_shortcut_get_action GtkShortcut* self")
(CFNC-3.98 "void gtk_shortcut_set_action GtkShortcut* self GtkShortcutAction* action")
(CFNC-3.98 "GVariant* gtk_shortcut_get_arguments GtkShortcut* self")
(CFNC-3.98 "void gtk_shortcut_set_arguments GtkShortcut* self GVariant* vargs")
(CFNC-3.98 "char* gtk_shortcut_action_to_string GtkShortcutAction* self")
(CFNC-3.98 "void gtk_shortcut_action_print GtkShortcutAction* self GString* string")
(CFNC-3.98 "gboolean gtk_shortcut_action_activate GtkShortcutAction* self GtkShortcutActionFlags flags GtkWidget* widget GVariant* vargs")
(CFNC-3.98 "GtkShortcutAction* gtk_nothing_action_get void")
(CFNC-3.98 "GtkShortcutAction* gtk_callback_action_new GtkShortcutFunc callback gpointer func_info GDestroyNotify destroy")
(CFNC-3.98 "GtkShortcutAction* gtk_mnemonic_action_get void")
(CFNC-3.98 "GtkShortcutAction* gtk_activate_action_get void")
(CFNC-3.98 "GtkShortcutAction* gtk_signal_action_new char* signal_name" 'const)
(CFNC-3.98 "char* gtk_signal_action_get_signal_name GtkSignalAction* self" 'const)
(CFNC-3.98 "GtkShortcutAction* gtk_named_action_new char* name" 'const)
(CFNC-3.98 "char* gtk_named_action_get_action_name GtkNamedAction* self" 'const)
(CFNC-3.98 "GtkEventController* gtk_shortcut_controller_new void")
(CFNC-3.98 "GtkEventController* gtk_shortcut_controller_new_for_model GListModel* list")
(CFNC-3.98 "void gtk_shortcut_controller_set_mnemonics_modifiers GtkShortcutController* self GdkModifierType modifiers")
(CFNC-3.98 "GdkModifierType gtk_shortcut_controller_get_mnemonics_modifiers GtkShortcutController* self")
(CFNC-3.98 "void gtk_shortcut_controller_set_scope GtkShortcutController* self GtkShortcutScope scope")
(CFNC-3.98 "GtkShortcutScope gtk_shortcut_controller_get_scope GtkShortcutController* self")
(CFNC-3.98 "void gtk_shortcut_controller_add_shortcut GtkShortcutController* self GtkShortcut* shortcut")
(CFNC-3.98 "void gtk_shortcut_controller_remove_shortcut GtkShortcutController* self GtkShortcut* shortcut")
(CFNC-3.98 "GtkShortcutTrigger* gtk_shortcut_trigger_parse_string char* string" 'const)
(CFNC-3.98 "char* gtk_shortcut_trigger_to_string GtkShortcutTrigger* self")
(CFNC-3.98 "void gtk_shortcut_trigger_print GtkShortcutTrigger* self GString* string")
(CFNC-3.98 "char* gtk_shortcut_trigger_to_label GtkShortcutTrigger* self GdkDisplay* display")
(CFNC-3.98 "gboolean gtk_shortcut_trigger_print_label GtkShortcutTrigger* self GdkDisplay* display GString* string")
(CFNC-3.98 "guint gtk_shortcut_trigger_hash gconstpointer trigger")
(CFNC-3.98 "gboolean gtk_shortcut_trigger_equal gconstpointer trigger1 gconstpointer trigger2")
(CFNC-3.98 "gint gtk_shortcut_trigger_compare gconstpointer trigger1 gconstpointer trigger2")
(CFNC-3.98 "GtkShortcutTrigger* gtk_never_trigger_get void")
(CFNC-3.98 "GtkShortcutTrigger* gtk_keyval_trigger_new guint keyval GdkModifierType modifiers")
(CFNC-3.98 "GdkModifierType gtk_keyval_trigger_get_modifiers GtkKeyvalTrigger* self")
(CFNC-3.98 "guint gtk_keyval_trigger_get_keyval GtkKeyvalTrigger* self")
(CFNC-3.98 "GtkShortcutTrigger* gtk_mnemonic_trigger_new guint keyval")
(CFNC-3.98 "guint gtk_mnemonic_trigger_get_keyval GtkMnemonicTrigger* self")
(CFNC-3.98 "GtkShortcutTrigger* gtk_alternative_trigger_new GtkShortcutTrigger* first GtkShortcutTrigger* second")
(CFNC-3.98 "GtkShortcutTrigger* gtk_alternative_trigger_get_first GtkAlternativeTrigger* self")
(CFNC-3.98 "GtkShortcutTrigger* gtk_alternative_trigger_get_second GtkAlternativeTrigger* self")


;;; 3.98.3

(CINT-3.98 "GDK_KEY_MATCH_NONE" "GdkKeyMatch")
(CINT-3.98 "GDK_KEY_MATCH_PARTIAL" "GdkKeyMatch")
(CINT-3.98 "GDK_KEY_MATCH_EXACT" "GdkKeyMatch")

(CINT-3.98 "GTK_STATE_FLAG_FOCUS_WITHIN" "GtkStateFlags")
(CFNC-3.98 "GdkKeyMatch gtk_shortcut_trigger_trigger GtkShortcutTrigger* self GdkEvent* event gboolean enable_mnemonics")

(CFNC-3.98 "gboolean gdk_device_get_caps_lock_state GdkDevice* device")
(CFNC-3.98 "gboolean gdk_device_get_num_lock_state GdkDevice* device")
(CFNC-3.98 "gboolean gdk_device_get_scroll_lock_state GdkDevice* device")
(CFNC-3.98 "GdkModifierType gdk_device_get_modifier_state GdkDevice* device")
(CFNC-3.98 "PangoDirection gdk_device_get_direction GdkDevice* device")
(CFNC-3.98 "gboolean gdk_device_has_bidi_layouts GdkDevice* device")
(CFNC-3.98 "gboolean gdk_display_map_keyval GdkDisplay* display guint keyval GdkKeymapKey** [keys] int* [n_keys]")
(CFNC-3.98 "gboolean gdk_display_map_keycode GdkDisplay* display guint keycode GdkKeymapKey** [keys] guint** [keyvals] int* [n_entries]")
(CFNC-3.98 "double gdk_touchpad_event_get_pinch_angle_delta GdkEvent* event")
(CFNC-3.98 "double gdk_touchpad_event_get_pinch_scale GdkEvent* event")
(CFNC-3.98 "guint gdk_pad_event_get_button GdkEvent* event")
(CFNC-3.98 "void gdk_pad_event_get_axis_value GdkEvent* event guint* index double* value")
(CFNC-3.98 "GdkDrop* gdk_dnd_event_get_drop GdkEvent* event")
(CFNC-3.98 "gboolean gdk_grab_broken_event_get_implicit GdkEvent* event")
(CFNC-3.98 "GdkKeyMatch gdk_key_event_matches GdkEvent* event guint keyval GdkModifierType modifiers")
(CFNC-3.98 "gboolean gdk_key_event_get_match GdkEvent* event guint* keyval GdkModifierType* modifiers")
(CFNC-3.98 "GtkWidget* gtk_aspect_frame_new float xalign float yalign float ratio gboolean obey_child")
(CFNC-3.98 "void gtk_aspect_frame_set_xalign GtkAspectFrame* self float xalign")
(CFNC-3.98 "float gtk_aspect_frame_get_xalign GtkAspectFrame* self")
(CFNC-3.98 "void gtk_aspect_frame_set_yalign GtkAspectFrame* self float yalign")
(CFNC-3.98 "float gtk_aspect_frame_get_yalign GtkAspectFrame* self")
(CFNC-3.98 "void gtk_aspect_frame_set_ratio GtkAspectFrame* self float ratio")
(CFNC-3.98 "float gtk_aspect_frame_get_ratio GtkAspectFrame* self")
(CFNC-3.98 "void gtk_aspect_frame_set_obey_child GtkAspectFrame* self gboolean obey_child")
(CFNC-3.98 "gboolean gtk_aspect_frame_get_obey_child GtkAspectFrame* self")
(CFNC-3.98 "gboolean gtk_viewport_get_scroll_to_focus GtkViewport* viewport")
(CFNC-3.98 "void gtk_viewport_set_scroll_to_focus GtkViewport* viewport gboolean scroll_to_focus")
(CFNC-3.98 "void gtk_button_set_has_frame GtkButton* button gboolean has_frame")
(CFNC-3.98 "gboolean gtk_button_get_has_frame GtkButton* button")
(CFNC-3.98 "gboolean gtk_color_button_get_modal GtkColorButton* button")
(CFNC-3.98 "void gtk_color_button_set_modal GtkColorButton* button gboolean modal")
(CFNC-3.98 "GdkEvent* gtk_event_controller_get_current_event GtkEventController* controller")
(CFNC-3.98 "guint32 gtk_event_controller_get_current_event_time GtkEventController* controller")
(CFNC-3.98 "GdkDevice* gtk_event_controller_get_current_event_device GtkEventController* controller")
(CFNC-3.98 "GdkModifierType gtk_event_controller_get_current_event_state GtkEventController* controller")
(CFNC-3.98 "gboolean gtk_file_chooser_button_get_modal GtkFileChooserButton* button")
(CFNC-3.98 "void gtk_file_chooser_button_set_modal GtkFileChooserButton* button gboolean modal")
(CFNC-3.98 "gboolean gtk_font_button_get_modal GtkFontButton* font_button")
(CFNC-3.98 "void gtk_font_button_set_modal GtkFontButton* font_button gboolean modal")
(CFNC-3.98 "void gtk_menu_button_set_has_frame GtkMenuButton* menu_button gboolean has_frame")
(CFNC-3.98 "gboolean gtk_menu_button_get_has_frame GtkMenuButton* menu_button")
;(CFNC-3.98 "gboolean gtk_buildable_attribute_tag_start GtkBuildable* buildable GtkBuilder* builder GObject* child const gchar* tagname GtkBuildableParser* parser gpointer* data")
;(CFNC-3.98 "voidgtk_pango_attribute_start_element GtkBuildableParseContext* context const char* element_name const char** names const char** values gpointer user_data GError** [error]")
(CFNC-3.98 "void gtk_scrolled_window_set_has_frame GtkScrolledWindow* scrolled_window gboolean has_frame")
(CFNC-3.98 "gboolean gtk_scrolled_window_get_has_frame GtkScrolledWindow* scrolled_window")
(CFNC-3.98 "GtkShortcutAction* gtk_shortcut_action_parse_string char* string" 'const)
;(CFNC-3.98 "void gtk_show_uri_full GtkWindow* parent char* uri guint32 timestamp GCancellable* cancellable GAsyncReadyCallback callback gpointer user_data" 'const)
(CFNC-3.98 "gboolean gtk_show_uri_full_finish GtkWindow* parent GAsyncResult* result GError** [error]")
(CFNC-3.98 "void gtk_show_uri GtkWindow* parent char* uri guint32 timestamp" 'const)

;;; 3.98.4
(CCAST-3.98 "GTK_WINDOW_HANDLE" "GtkWindowHandle*")
(CCHK-3.98 "GTK_IS_WINDOW_HANDLE" "GtkWindowHandle*")
(CCAST-3.98 "GTK_WINDOW_CONTROLS" "GtkWindowControls*")
(CCHK-3.98 "GTK_IS_WINDOW_CONTROLS" "GtkWindowControls*")

(CINT-3.98 "GTK_SYSTEM_SETTING_DPI" "GtkSystemSetting")
(CINT-3.98 "GTK_SYSTEM_SETTING_FONT_NAME" "GtkSystemSetting")
(CINT-3.98 "GTK_SYSTEM_SETTING_FONT_CONFIG" "GtkSystemSetting")
(CINT-3.98 "GTK_SYSTEM_SETTING_DISPLAY" "GtkSystemSetting")
(CINT-3.98 "GTK_SYSTEM_SETTING_ICON_THEME" "GtkSystemSetting")

(CFNC-3.98 "gboolean gtk_widget_translate_coordinates GtkWidget* src_widget GtkWidget* dest_widget double src_x double src_y double* [dest_x] double* [dest_y]")
(CFNC-3.98 "GdkTimeCoord* gdk_motion_event_get_history GdkEvent* event guint* [out_n_coords]")
(CFNC-3.98 "void gdk_toplevel_begin_resize GdkToplevel* toplevel GdkSurfaceEdge edge GdkDevice* device int button double x double y guint32 timestamp")
(CFNC-3.98 "void gdk_toplevel_begin_move GdkToplevel* toplevel GdkDevice* device int button double x double y guint32 timestamp")
(CFNC-3.98 "GtkWidget** gtk_text_child_anchor_get_widgets GtkTextChildAnchor* anchor guint* [out_len]")
(CFNC-3.98 "void gtk_action_bar_remove GtkActionBar* action_bar GtkWidget* child")
(CFNC-3.98 "void gtk_aspect_frame_set_child GtkAspectFrame* self GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_aspect_frame_get_child GtkAspectFrame* self")
(CFNC-3.98 "void gtk_box_append GtkBox* box GtkWidget* child")
(CFNC-3.98 "void gtk_box_prepend GtkBox* box GtkWidget* child")
(CFNC-3.98 "void gtk_box_remove GtkBox* box GtkWidget* child")
(CFNC-3.98 "void gtk_button_set_child GtkButton* button GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_button_get_child GtkButton* button")
(CFNC-3.98 "void gtk_combo_box_set_child GtkComboBox* combo_box GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_combo_box_get_child GtkComboBox* combo_box")
(CFNC-3.98 "void gtk_expander_set_child GtkExpander* expander GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_expander_get_child GtkExpander* expander")
(CFNC-3.98 "void gtk_frame_set_child GtkFrame* frame GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_frame_get_child GtkFrame* frame")
(CFNC-3.98 "void gtk_popover_set_child GtkPopover* popover GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_popover_get_child GtkPopover* popover")
(CFNC-3.98 "void gtk_revealer_set_child GtkRevealer* revealer GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_revealer_get_child GtkRevealer* revealer")
(CFNC-3.98 "void gtk_scrolled_window_set_child GtkScrolledWindow* scrolled_window GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_scrolled_window_get_child GtkScrolledWindow* scrolled_window")
(CFNC-3.98 "void gtk_search_bar_set_child GtkSearchBar* bar GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_search_bar_get_child GtkSearchBar* bar")
(CFNC-3.98 "void gtk_viewport_set_child GtkViewport* viewport GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_viewport_get_child GtkViewport* viewport")
(CFNC-3.98 "void gtk_window_set_child GtkWindow* window GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_window_get_child GtkWindow* window")
(CFNC-3.98 "void gtk_fixed_remove GtkFixed* fixed GtkWidget* widget")
(CFNC-3.98 "void gtk_flow_box_remove GtkFlowBox* box GtkWidget* widget")
(CFNC-3.98 "void gtk_flow_box_child_set_child GtkFlowBoxChild* self GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_flow_box_child_get_child GtkFlowBoxChild* self")
(CFNC-3.98 "void gtk_grid_remove GtkGrid* grid GtkWidget* child")
(CFNC-3.98 "void gtk_native_get_surface_transform GtkNative* self double* [x] double* [y]")
(CFNC-3.98 "void gtk_stack_remove GtkStack* stack GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_window_controls_new GtkPackType side")
(CFNC-3.98 "GtkPackType gtk_window_controls_get_side GtkWindowControls* self")
(CFNC-3.98 "void gtk_window_controls_set_side GtkWindowControls* self GtkPackType side")
(CFNC-3.98 "char* gtk_window_controls_get_decoration_layout GtkWindowControls* self" 'const-return)
(CFNC-3.98 "void gtk_window_controls_set_decoration_layout GtkWindowControls* self char* layout" 'const)
(CFNC-3.98 "gboolean gtk_window_controls_get_empty GtkWindowControls* self")
(CFNC-3.98 "void gtk_window_destroy GtkWindow* window")
(CFNC-3.98 "GtkWidget* gtk_window_handle_new void")
(CFNC-3.98 "GtkWidget* gtk_window_handle_get_child GtkWindowHandle* self")
(CFNC-3.98 "void gtk_window_handle_set_child GtkWindowHandle* self GtkWidget* child")
(CFNC-3.98 "void gtk_overlay_remove_overlay GtkOverlay* overlay GtkWidget* widget")
(CFNC-3.98 "void gtk_overlay_set_child GtkOverlay* overlay GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_overlay_get_child GtkOverlay* overlay")
(CFNC-3.98 "void gtk_text_view_remove GtkTextView* text_view GtkWidget* child")
(CFNC-3.98 "void gtk_info_bar_remove_action_widget GtkInfoBar* info_bar GtkWidget* widget")
(CFNC-3.98 "void gtk_info_bar_add_child GtkInfoBar* info_bar GtkWidget* widget")
(CFNC-3.98 "void gtk_info_bar_remove_child GtkInfoBar* info_bar GtkWidget* widget")
(CFNC-3.98 "void gtk_list_box_remove GtkListBox* box GtkWidget* child")
(CFNC-3.98 "void gtk_list_box_row_set_child GtkListBoxRow* row GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_list_box_row_get_child GtkListBoxRow* row")
(CFNC-3.98 "void gtk_header_bar_remove GtkHeaderBar* bar GtkWidget* child")
(CFNC-3.98 "void gtk_widget_set_focusable GtkWidget* widget gboolean focusable")
(CFNC-3.98 "gboolean gtk_widget_get_focusable GtkWidget* widget")
(CFNC-3.98 "void gtk_paned_set_start_child GtkPaned* paned GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_paned_get_start_child GtkPaned* paned")
(CFNC-3.98 "void gtk_paned_set_resize_start_child GtkPaned* paned gboolean resize")
(CFNC-3.98 "gboolean gtk_paned_get_resize_start_child GtkPaned* paned")
(CFNC-3.98 "void gtk_paned_set_end_child GtkPaned* paned GtkWidget* child")
(CFNC-3.98 "GtkWidget* gtk_paned_get_end_child GtkPaned* paned")
(CFNC-3.98 "void gtk_paned_set_shrink_start_child GtkPaned* paned gboolean resize")
(CFNC-3.98 "gboolean gtk_paned_get_shrink_start_child GtkPaned* paned")
(CFNC-3.98 "void gtk_paned_set_resize_end_child GtkPaned* paned gboolean resize")
(CFNC-3.98 "gboolean gtk_paned_get_resize_end_child GtkPaned* paned")
(CFNC-3.98 "void gtk_paned_set_shrink_end_child GtkPaned* paned gboolean resize")
(CFNC-3.98 "gboolean gtk_paned_get_shrink_end_child GtkPaned* paned")
(CFNC-3.98 "gint gtk_paned_get_position GtkPaned* paned")
(CFNC-3.98 "void gtk_paned_set_position GtkPaned* paned gint position")

(CFNC-3.98 "GDateTime* gtk_calendar_get_date GtkCalendar* self")
(CFNC-3.98 "void gtk_accelerator_parse_with_keycode gchar* accelerator GdkDisplay* display guint* accelerator_key guint** accelerator_codes GdkModifierType* accelerator_mods" 'const)
