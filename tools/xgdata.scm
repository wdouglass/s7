...
;;; 3.94.0 (CFNC "void gdk_drop_finish GdkDragContext* context gboolean success guint32 time")
...
;;; 3.94.0 (CFNC-3.18 "void gtk_places_sidebar_set_drop_targets_visible GtkPlacesSidebar* sidebar gboolean visible GdkDragContext* context")
...
(CINT-3.92 "GTK_CSS_PROVIDER_ERROR_FAILED" "GtkCssProviderError")
(CINT-3.92 "GTK_CSS_PROVIDER_ERROR_SYNTAX" "GtkCssProviderError")
(CINT-3.92 "GTK_CSS_PROVIDER_ERROR_IMPORT" "GtkCssProviderError")
(CINT-3.92 "GTK_CSS_PROVIDER_ERROR_NAME" "GtkCssProviderError")
(CINT-3.92 "GTK_CSS_PROVIDER_ERROR_DEPRECATED" "GtkCssProviderError")
(CINT-3.92 "GTK_CSS_PROVIDER_ERROR_UNKNOWN_VALUE" "GtkCssProviderError")
...
(CFNC-3.92 "GtkCssProvider* gtk_css_provider_get_default void")
(CFNC-3.92 "GtkCssProvider* gtk_css_provider_get_named gchar* name gchar* variant" 'const)
...
(CFNC-3.99 "gboolean gdk_event_get_string GdkEvent* event char** [string]" 'const)
...
(CFNC-3.99 "gboolean gdk_event_get_drag_context GdkEvent* event GdkDragContext** [context]")
...
;;; 3.93.0 (CFNC-3.99 "GdkDragContext* gdk_drag_begin GdkSurface* window GList* targets")
;;; (CFNC-gtk2 "void gdk_drag_find_window GdkDragContext* context GdkSurface* drag_window gint x_root gint y_root GdkSurface** [dest_window] GdkDragProtocol* [protocol]")
;;; (CFNC-gtk2 "gboolean gdk_drag_motion GdkDragContext* context GdkSurface* dest_window GdkDragProtocol protocol gint x_root gint y_root GdkDragAction suggested_action GdkDragAction possible_actions guint32 time")
...
;;; 3.93.0 (CFNC-3.20 "GdkDragContext* gdk_drag_begin_from_point GdkSurface* window GdkDevice* device GList* targets gint x_root gint y_root")
;;; 3.93.0 (CFNC-3.20 "gboolean gdk_drag_context_manage_dnd GdkDragContext* context GdkSurface* ipc_window GdkDragAction actions")
...
(CINT-3.99 "GDK_SURFACE_SUBSURFACE" "GdkSurfaceType")
...
(CFNC-3.99 "GList* gdk_surface_get_children_with_user_data GdkSurface* surface gpointer user_data")
...
(CFNC-3.99 "GdkDragContext* gdk_drag_begin GdkSurface* window GdkDevice* device GdkContentProvider* content GdkDragAction actions gint dx gint dy")
...
(CFNC-3.99 "GdkSurface* gdk_drag_context_get_drag_window GdkDragContext* context")
(CFNC-3.99 "GdkSurface* gdk_drag_context_get_source_window GdkDragContext* context")
...
(CFNC-3.99 "GdkSurface* gdk_surface_get_device_position GdkSurface* surface GdkDevice* device gint* x gint* y GdkModifierType* mask")
(CFNC-3.99 "GdkSurface* gdk_surface_get_device_position_double GdkSurface* surface GdkDevice* device gdouble* x gdouble* y GdkModifierType* mask")
(CFNC-3.99 "GdkSurface* gdk_surface_get_group GdkSurface* window")
...
(CFNC-3.99 "void gdk_surface_begin_move_drag GdkSurface* surface gint button gint root_x gint root_y guint32 timestamp")
(CFNC-3.99 "void gdk_surface_begin_move_drag_for_device GdkSurface* surface GdkDevice* device gint button gint root_x gint root_y guint32 timestamp")
...
(CFNC-3.99 "void gdk_surface_begin_resize_drag_for_device GdkSurface* surface GdkSurfaceEdge edge GdkDevice* device gint button gint root_x gint root_y guint32 timestamp")
...
(CFNC-3.99 "void gdk_surface_invalidate_rect GdkSurface* surface const GdkRectangle* rect")
(CFNC-3.99 "void gdk_surface_invalidate_region GdkSurface* surface const cairo_region_t* region")
...
(CFNC-3.99 "void gdk_surface_set_group GdkSurface* surface GdkSurface* leader")
...
(CFNC-3.99 "void gdk_surface_set_role GdkSurface* surface const gchar* role")
...
(CFNC-3.99 "void gdk_surface_set_urgency_hint GdkSurface* surface gboolean urgent")
...
(CFNC-3.99 "void gdk_surface_withdraw GdkSurface* surface")
...
(CFNC-3.99 "void gtk_window_begin_resize_drag GtkWindow* window GdkSurfaceEdge edge gint button gint root_x gint root_y guint32 timestamp")
...
(CFNC-3.99 "GdkDragContext* gdk_drop_get_drag GdkDrop* self")
...
(CFNC-3.99 "GInputStream* gdk_drop_read_finish GdkDrop* self const char** out_mime_type GAsyncResult* result GError** error")
...
(CFNC-3.99 "void gdk_paintable_snapshot GdkPaintable* paintable GdkSnapshot* snapshot double width double height")
