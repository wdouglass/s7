...
(CFNC-3.94 "GInputStream* gdk_clipboard_read_finish GdkClipboard* clipboard char** out_mime_type GAsyncResult* result GError** [error]" 'const)
...
(CFNC-3.94 "void gdk_device_get_position GdkDevice* device gint* [x] gint* [y]")
(CFNC-3.94 "void gdk_device_get_position_double GdkDevice* device gdouble* [x] gdouble* [y]")
...
(CFNC-3.94 "void gtk_window_set_default_icon GdkTexture* icon")
...
(CFNC-3.94 "GdkSurface* gdk_surface_get_group GdkSurface* surface")
...
(CFNC-3.94 "void gdk_surface_get_user_data GdkSurface* surface gpointer* data")
...
(CFNC-3.94 "void gdk_surface_set_skip_pager_hint GdkSurface* surface gboolean skips_pager")
(CFNC-3.94 "void gdk_surface_set_skip_taskbar_hint GdkSurface* surface gboolean skips_taskbar")
...
(CFNC-3.94 "void gdk_surface_set_user_data GdkSurface* @window gpointer user_data")
...
;;; 3.96.0:
(CFNC-3.96 "void gtk_box_reorder_child GtkBox* box GtkWidget* child GtkWidget* sibling")
...
(CFNC-3.96 "gboolean gdk_surface_handle_event GdkEvent* event")
(CFNC-3.96 "GdkGrabStatus gdk_device_grab GdkDevice* device GdkSurface* surface GdkGrabOwnership grab_ownership gboolean owner_events GdkEventMask event_mask GdkCursor* cursor guint32 time_")
(CFNC-3.96 "void gdk_device_ungrab GdkDevice* device guint32 time_")
(CFNC-3.96 "void gtk_application_set_screensaver_active GtkApplication* application gboolean active")
...
(CFNC-3.96 "float gtk_editable_get_alignment GtkEditable* editable")
...
(CFNC-3.96 "void gtk_fixed_layout_child_set_position GtkFixedLayoutChild* child GskTransform* gtk_fixed_layout_child_get_position GtkFixedLayoutChild* child")
...
(CFNC-3.96 "void gtk_drag_get_data GtkWidget* widget GdkDrag* context GdkAtom target guint32 time")
...
(CFNC-3.96 "void gtk_drag_set_icon_surface GdkDrag* context cairo_surface_t* surface")
...
(CFNC-3.96 "void gtk_drag_finish GdkDrag* context gboolean success guint32 time")
(CFNC-3.96 "void gtk_drag_set_icon_pixbuf GdkDrag* context GdkTexture* texture gint hot_x gint hot_y")
(CFNC-3.96 "char* gtk_drag_dest_find_target GtkWidget* widget GdkDrag* context GdkContentFormats* @target_list" 'const-return)
