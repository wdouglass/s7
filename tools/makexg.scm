...
(define no-xen-to-c 
  (list "GdkXEvent*" "GSignalInvocationHint*" "GdkVisualType*" "GError*" "GtkAccelGroupEntry*" "GtkIconSize*" "AtkObject*" 
	...
	"GdkEventMotion*"
	"GtkCssSection*" "GdkPaintableFlags"
	"GtkTreeViewDropPosition" "GtkIconViewDropPosition" "GdkKeyMatch"
	"GIcon*"
	))
...
(define direct-types 
  (list (cons "void" #f)
	...
	(cons "GdkInputSource" "INT")
	(cons "GtkAccessibleRole" "INT")
	(cons "GtkAccessibleState" "INT")
	(cons "GtkAccessibleProperty" "INT")
	(cons "GtkAccessibleRelation" "INT")
	(cons "GtkAccessibleInvalidState" "INT")
...
(hey "#if HAVE_SCHEME~%")
(hoy "static s7_pointer xm_obj_free(s7_scheme *sc, s7_pointer obj)~%")
(hoy "{~%")
(hoy "  free(s7_c_object_value(obj));~%")
(hoy "  return(NULL);~%")
(hoy "}~%")
(hoy "static s7_pointer s7_equal_xm(s7_scheme *sc, s7_pointer args)~%")
(hoy "{~%")
(hoy "  return(s7_make_boolean(sc, s7_car(args) == s7_cadr(args)));~%")
(hoy "}~%")
(hey "#endif~%")
...
(hey "  s7_c_type_set_gc_free(s7, xm_obj_tag, xm_obj_free);~%")
(hay "  s7_c_type_set_gc_free(sc, xm_obj_tag, xm_obj_free);~%")
(hey "  s7_c_type_set_is_equal(s7, xm_obj_tag, s7_equal_xm);~%")
(hay "  s7_c_type_set_is_equal(sc, xm_obj_tag, s7_equal_xm);~%")
(hey "#else~%")
