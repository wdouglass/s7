...
#|
  (for-each 
   (lambda (c)
	...
	(for-each
	 (lambda (a)
	   (try34 `(+ ,a ,b ,c) gen make-gen nargs)
	   (try34 `(+ (* ,a ,b) ,c) gen make-gen nargs)
	   (try34 `(+ ,a (* ,b ,c)) gen make-gen nargs)
	   (try34 `(* ,a ,b ,c) gen make-gen nargs)
	   (try34 `(* ,a (+ ,b ,c)) gen make-gen nargs)
	   (try34 `(* (+ ,a ,b) ,c) gen make-gen nargs)
	   (when (> nargs 1)
	     (try34 `(,gen o (+ ,a ,b ,c)) gen make-gen nargs)
	     (try34 `(,gen o (* ,a ,b ,c)) gen make-gen nargs)
	     (try34 `(,gen o (* ,a (+ ,b ,c))) gen make-gen nargs)
	     (try34 `(,gen o (+ ,a (* ,b ,c))) gen make-gen nargs)
	     (try34 `(,gen o (* (+ ,a ,b) ,c)) gen make-gen nargs)
	     (try34 `(,gen o (+ (* ,a ,b) ,c)) gen make-gen nargs)
	     (try34 `(+ ,a (,gen o (+ ,b ,c))) gen make-gen nargs)
	     (try34 `(+ ,a (,gen o (* ,b ,c))) gen make-gen nargs)
	     (try34 `(* ,a (,gen o (+ ,b ,c))) gen make-gen nargs)
	     (try34 `(* ,a (,gen o (* ,b ,c))) gen make-gen nargs)
	     
	     (try34 `(+ ,a ,b (,gen o ,c)) gen make-gen nargs)
	     (try34 `(* ,a ,b (,gen o ,c)) gen make-gen nargs)
	     (try34 `(+ (* ,a ,b) (,gen o ,c)) gen make-gen nargs)
	     (try34 `(* (+ ,a ,b) (,gen o ,c)) gen make-gen nargs)
	     (try34 `(+ ,a (* ,b (,gen o ,c))) gen make-gen nargs)
	   ...
	   (try34 `(+ ,a (abs ,b) ,c) gen make-gen nargs)
	   (try34 `(+ ,a (sin ,b) ,c) gen make-gen nargs)
	   (try34 `(+ ,a (cos ,b) ,c) gen make-gen nargs))
	 args3))
      args2))
   args1)
   ...
   (lambda (d)
	...
	(for-each
	 (lambda (b)
	   (for-each
	    (lambda (a)
	      (try34 `(+ ,a ,b ,c ,d) gen make-gen nargs)
	      (try34 `(* ,a ,b ,c ,d) gen make-gen nargs)
	      (try34 `(+ (* ,a ,b) (* ,c ,d)) gen make-gen nargs)
	      (try34 `(* (+ ,a ,b) (+ ,c ,d)) gen make-gen nargs)
	      (try34 `(+ ,a (* ,b ,c ,d)) gen make-gen nargs)
	      ...
	      (when (> nargs 1)
		(try34 `(+ (,gen o ,a) ,b ,c ,d) gen make-gen nargs)
		(try34 `(* (,gen o ,a) ,b ,c ,d) gen make-gen nargs)
		(try34 `(+ (* (,gen o ,a) ,b) (* ,c ,d)) gen make-gen nargs)
		(try34 `(* (+ (,gen o ,a) ,b) (+ ,c ,d)) gen make-gen nargs)
		(try34 `(+ (,gen o ,a) (* ,b ,c ,d)) gen make-gen nargs)
		...
		(try34 `(+ ,a (,gen o ,b) ,c ,d) gen make-gen nargs)
		(try34 `(* ,a (,gen o ,b) ,c ,d) gen make-gen nargs)
		(try34 `(+ (* ,a (,gen o ,b)) (* ,c ,d)) gen make-gen nargs)
		(try34 `(* (+ ,a (,gen o ,b)) (+ ,c ,d)) gen make-gen nargs)
		(try34 `(+ ,a (* (,gen o ,b) ,c ,d)) gen make-gen nargs)
		...
		(try34 `(+ ,a ,b (,gen o ,c) ,d) gen make-gen nargs)
		(try34 `(* ,a ,b (,gen o ,c) ,d) gen make-gen nargs)
		(try34 `(+ (* ,a ,b) (* (,gen o ,c) ,d)) gen make-gen nargs)
		(try34 `(* (+ ,a ,b) (+ (,gen o ,c) ,d)) gen make-gen nargs)
		(try34 `(+ ,a (* ,b (,gen o ,c) ,d)) gen make-gen nargs)
		...
		(try34 `(+ ,a ,b ,c (,gen o ,d)) gen make-gen nargs)
		(try34 `(* ,a ,b ,c (,gen o ,d)) gen make-gen nargs)
		(try34 `(+ (* ,a ,b) (* ,c (,gen o ,d))) gen make-gen nargs)
		(try34 `(* (+ ,a ,b) (+ ,c (,gen o ,d))) gen make-gen nargs)
		(try34 `(+ ,a (* ,b ,c (,gen o ,d))) gen make-gen nargs)
		...
		(try34 `(* (+ ,a (,gen o (* ,b ,c))) ,d) gen make-gen nargs))
	      ...
	      (try34 `(+ ,a ,b ,c ,d (,gen o)) gen make-gen nargs)
	      (try34 `(* ,a ,b ,c ,d (,gen o)) gen make-gen nargs))
	    args4))
	 args3))
      args2))
