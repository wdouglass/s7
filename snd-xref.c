...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "sublet", "subvector", "superimpose-ffts", "swap-channels", "swap-selection-channels", "symbol->dynamic-value",
 "symbol->value", "symbol-setter", "symbol-table", "sync", "sync-everything", "sync-max",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "sublet", "subvector", "superimpose_ffts", "swap_channels", "swap_selection_channels", "symbol2dynamic_value",
 "symbol2value", "symbol_setter", "symbol_table", "sync", "sync_everything", "sync_max",
