...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "open-raw-sound", "open-raw-sound-hook", "open-sound", "openlet", "openlet?", "openlets",
 ...
 "polywave?", "port-file", "port-filename", "port-line-number", "port-position", "position->x",
 ...
 "time-graph-type", "time-graph?", "times->samples", "tiny-font", "touch-tone", "tracking-cursor-style",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "open_raw_sound", "open_raw_sound_hook", "open_sound", "openlet", "openlet?", "openlets",
 ...
 "polywave?", "port_file", "port_filename", "port_line_number", "port_position", "position2x",
 ...
 "time_graph_type", "time_graph?", "times2samples", "tiny_font", "touch_tone", "tracking_cursor_style",
...
static const char *snd_names[11846] = {
...
{
  s7_autoload_set_names(sc, snd_names, 5923);
}
#endif
