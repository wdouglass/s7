...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "time-graph?", "times->samples", "tiny-font", "touch-tone", "tracking-cursor-style", "transform->float-vector",
 ...
 "tree-count", "tree-cyclic?", "tree-leaves", "tree-memq", "tree-set-memq", "triangle-wave",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "time_graph?", "times2samples", "tiny_font", "touch_tone", "tracking_cursor_style", "transform2float_vector",
 ...
 "tree_count", "tree_cyclic?", "tree_leaves", "tree_memq", "tree_set_memq", "triangle_wave",
