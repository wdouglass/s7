...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "polyshape?", "polywave", "polywave?", "port-filename", "port-line-number", "port-position",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "polyshape?", "polywave", "polywave?", "port_filename", "port_line_number", "port_position",
