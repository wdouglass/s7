...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "make-two-zero", "make-variable-display", "make-variable-graph", "make-vector", "make-wave-train", "make-wave-train-with-env",
 "make-weak-hash-table", "map-channel", "map-sound-files", "maracas", "mark->integer", "mark-click-hook",
 ...
 "mix-float-vector", "mix-home", "mix-length", "mix-maxamp", "mix-name", "mix-name->id",
 ...
 "mix-tag-width", "mix-tag-y", "mix-waveform-height", "mix?", "mixes", "mono->stereo",
 ...
 "open-raw-sound-hook", "open-sound", "openlet", "openlet?", "openlets", "orientation-hook",
 ...
 "port-file", "port-filename", "port-line-number", "port-position", "position->x", "position->y",
 "position-color", "power-env", "pqw", "pqw-vox", "preferences-dialog", "previous-sample",
 "print-dialog", "print-length", "procedure-source", "progress-report", "pulse-train", "pulse-train?",
 ...
 "redo", "region->float-vector", "region->integer", "region-chans", "region-framples", "region-graph-style",
 ...
 "rms-envelope", "rootlet", "*rootlet-redefinition-hook*", "round-interp", "round-interp?", "rssb",
 ...
 "selection-position", "selection-rms", "selection-srate", "selection?", "set-samples", "setter",
 ...
 "show-selection-transform", "show-sonogram-cursor", "show-transform-peaks", "show-widget", "show-y-zero", "signature",
 ...
 "start-progress-report", "status-report", "stdin-prompt", "stereo->mono", "stereo-flute", "stop-player",
 "stop-playing", "stop-playing-hook", "stop-playing-selection-hook", "stretch-envelope", "stretch-sound-via-dft", "string->byte-vector",
 "string-position", "sublet", "subvector", "subvector-position", "subvector-vector", "subvector?",
 "superimpose-ffts", "swap-channels", "swap-selection-channels", "symbol->dynamic-value", "symbol->value", "symbol-table",
 ...
 "transpose-mixes", "tree-count", "tree-cyclic?", "tree-leaves", "tree-memq", "tree-set-memq",
 ...
 "waveshaping voice", "wavo-hop", "wavo-trace", "weak-hash-table", "weak-hash-table?", "weighted-moving-average",
...
static const char *help_names[HELP_NAMES_SIZE] = {
 ...
 "hash_table", "hash_table_entries", "hash_table_ref", "hash_table_set!", "hash_table?", "header_type",
 ...
 "make_two_zero", "make_variable_display", "make_variable_graph", "make_vector", "make_wave_train", "make_wave_train_with_env",
 "make_weak_hash_table", "map_channel", "map_sound_files", "maracas", "mark2integer", "mark_click_hook",
 ...
 "mix_float_vector", "mix_home", "mix_length", "mix_maxamp", "mix_name", "mix_name2id",
 ...
 "mix_tag_width", "mix_tag_y", "mix_waveform_height", "mix?", "mixes", "mono2stereo",
 ...
 "open_raw_sound_hook", "open_sound", "openlet", "openlet?", "openlets", "orientation_hook",
 ...
 "port_file", "port_filename", "port_line_number", "port_position", "position2x", "position2y",
 "position_color", "power_env", "pqw", "pqw_vox", "preferences_dialog", "previous_sample",
 "print_dialog", "print_length", "procedure_source", "progress_report", "pulse_train", "pulse_train?",
 ...
 "redo_edit", "region2float_vector", "region2integer", "region_chans", "region_framples", "region_graph_style",
 ...
 "rms_envelope", "rootlet", "_rootlet_redefinition_hook_", "round_interp", "round_interp?", "rssb",
 ...
 "selection_position", "selection_rms", "selection_srate", "selection?", "set_samples", "setter",
 ...
 "show_selection_transform", "show_sonogram_cursor", "show_transform_peaks", "show_widget", "show_y_zero", "signature",
 ...
 "start_progress_report", "status_report", "stdin_prompt", "stereo2mono", "stereo_flute", "stop_player",
 "stop_playing", "stop_playing_hook", "stop_playing_selection_hook", "stretch_envelope", "stretch_sound_via_dft", "string2byte_vector",
 "string_position", "sublet", "subvector", "subvector_position", "subvector_vector", "subvector?",
 "superimpose_ffts", "swap_channels", "swap_selection_channels", "symbol2dynamic_value", "symbol2value", "symbol_table",
 ...
 "transpose_mixes", "tree_count", "tree_cyclic?", "tree_leaves", "tree_memq", "tree_set_memq",
 ...
 "waveshaping_voice", "wavo_hop", "wavo_trace", "weak_hash_table", "weak_hash_table?", "weighted_moving_average",
...
static const char *help_urls[HELP_NAMES_SIZE] = {
 ...
 "s7.html#isfunclet", "sndscm.html#gaussiandistribution", "extsnd.html#gcoff", "extsnd.html#gcon",
 ...
 "s7.html#openlets", "extsnd.html#orientationhook", "sndclm.html#oscil", "sndclm.html#oscil-bank",
 ...
 "sndclm.html#polywave", "sndclm.html#polywave?", "s7.html#portfile", "s7.html#portfilename",
 "s7.html#portlinenumber", "s7.html#portposition", "extsnd.html#positiontox", "extsnd.html#positiontoy",
 ...
 "sndclm.html#rectangulartomagnitudes", "sndclm.html#rectangulartopolar", "extsnd.html#redo", "extsnd.html#regiontofv",
 "extsnd.html#regiontointeger", "extsnd.html#regionchans", "extsnd.html#regionframples", "extsnd.html#regiongraphstyle",
 ...
 "s7.html#rootletredefinitionhook", "sndclm.html#round-interp", "sndclm.html#round-interp?", "sndclm.html#rssb",
 ...
 "extsnd.html#setsamples", "s7.html#setter", "extsnd.html#shortfilename", "extsnd.html#showaxes",
 ...
 "extsnd.html#showtransformpeaks", "extsnd.html#showwidget", "extsnd.html#showyzero", "s7.html#signature",
 ...
 "s7.html#subvector", "s7.html#subvectorposition", "s7.html#subvectorvector", "s7.html#subvectorp",
 "sndscm.html#superimposeffts", "extsnd.html#swapchannels", "sndscm.html#swapselectionchannels", "s7.html#symboltodynamicvalue",
 "s7.html#symboltovalue", "s7.html#symboltable", "extsnd.html#sync", "sndscm.html#sync-everything",
